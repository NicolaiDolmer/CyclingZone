...
export function processSnapshot() {
  ...
  const observed = JSON.parse(execFileSync('pwsh', ['-NoProfile', '-Command',
    '$ErrorActionPreference="Stop"; @{ bootId=(Get-CimInstance Win32_OperatingSystem).LastBootUpTime.ToUniversalTime().Ticks.ToString(); processes=@(Get-CimInstance Win32_Process | Select-Object @{n="pid";e={[int]$_.ProcessId}}, @{n="ppid";e={[int]$_.ParentProcessId}}) } | ConvertTo-Json -Compress'], { encoding: 'utf8', timeout: 15000 }));
