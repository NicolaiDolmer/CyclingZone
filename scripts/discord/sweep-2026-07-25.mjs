#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild since last sweep (2026-07-23-pm).
 ...
 * Output: scripts/discord/.sweep-2026-07-25.md
 */
...
const SINCE_ISO = '2026-07-23T19:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-25.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-25 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
  out += `## Kanal-inventar\n`;
