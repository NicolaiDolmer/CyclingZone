#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild since last full sweep (2026-07-15).
 ...
 * Output: scripts/discord/.sweep-2026-07-16.md
 */
...
const SINCE_ISO = '2026-07-15T00:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-16.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-16 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
  out += `## Kanal-inventar\n`;
