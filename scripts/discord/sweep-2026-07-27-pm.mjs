#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild since last sweep (2026-07-27 ~07:09 UTC).
 ...
 * Output: scripts/discord/.sweep-2026-07-27-pm.md
 */
...
const SINCE_ISO = '2026-07-27T07:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-27-pm.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-27 PM — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
