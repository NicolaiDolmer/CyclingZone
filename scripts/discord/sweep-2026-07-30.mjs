#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild — FULD UGE (siden 2026-07-23 00:00 UTC).
 * Ejer-request 30/7: læs hele ugens aktivitet i ALLE kanaler, ikke kun siden sidste sweep.
 ...
 * Output: scripts/discord/.sweep-2026-07-30.md
 */
...
const SINCE_ISO = '2026-07-23T00:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-30.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-30 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO} (fuld uge, ejer-request)\n\n`;
