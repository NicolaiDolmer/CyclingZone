#!/usr/bin/env node
/**
 * Dump full content of the 2 newest landing-copy threads (2026-06-21 late),
 * newer than cutoff 1518341550285918378. Token from env; never printed.
 * Output: scripts/discord/.new-threads-2026-06-21-late.md
 */
import fs from 'node:fs';
import path from 'node:path';
const API = 'https://discord.com/api/v10';
const THREADS = [
  ['1518347996545155162', 'Rettelser til "The game is built in the open" (@cybersimon)'],
  ['1518347491047899167', 'Fortsættelse af landingsside - Engelsk (@jeppek)'],
];
...
async function main() {
  ...
  let out = `# Landing-copy-tråde 2026-06-21 sen aften — nyere end 1518341550285918378\n\n`;
  ...
  fs.writeFileSync(path.join(process.cwd(),'scripts','discord','.new-threads-2026-06-21-late.md'), out);
