#!/usr/bin/env node
/**
 * Sweep 2026-06-27. Dumper "siden sidst FILEDE" cutoff.
 * Sidste FILEDE sweep = .file-issues-2026-06-25-pm.mjs (cutoff-tråd
 * 1519774212250665000, 2026-06-25 18:40). 26/6-dumpet blev lavet men IKKE
 * filed (intet .file-issues-2026-06-26.mjs), så de 2 tråde derfra (løn +
 * sortering) skal med her igen + evt. nyt fra 27/6.
 *
 * Kanaler:
 ...
 *
 * Token fra env; aldrig printet. Output: scripts/discord/.new-threads-2026-06-27.md
 */
...
const CUTOFF_THREAD = 1519774212250665000n; // sidste FILEDE 2026-06-25 18:40
const SINCE_ISO = '2026-06-26T00:00:00'; // chat: 26/6 + 27/6 (25/6-aften er allerede filed)
...
async function main() {
  ...
  let out = `# Discord-sweep 2026-06-27 — siden FILED cutoff ${CUTOFF_THREAD} (2026-06-25 18:40)\n\n`;
  ...
  const file = path.join(process.cwd(), 'scripts', 'discord', '.new-threads-2026-06-27.md');
