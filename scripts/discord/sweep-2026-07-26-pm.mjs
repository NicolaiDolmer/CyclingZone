#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild since last sweep (2026-07-25).
 ...
 * Output: scripts/discord/.sweep-2026-07-26-pm.md
 */
...
const SINCE_ISO = '2026-07-25T07:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-26-pm.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-26-pm — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
  out += `## Kanal-inventar\n`;
