#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild since last sweep (2026-07-27 PM, cutoff 15:30 UTC).
 ...
 * Output: scripts/discord/.sweep-2026-07-28.md
 */
...
const SINCE_ISO = '2026-07-27T15:30:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-28.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-28 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
