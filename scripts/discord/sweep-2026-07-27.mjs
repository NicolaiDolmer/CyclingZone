...
const SINCE_ISO = '2026-07-26T20:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-27.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-27 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
  out += `## Kanal-inventar\n`;
