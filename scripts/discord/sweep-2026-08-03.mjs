#!/usr/bin/env node
/**
 * READ-ONLY sweep of "Cycling Zone" guild — sidste 7 dage (siden 2026-07-27 00:00 UTC).
 * Ejer-request 3/8: læs alle nye indlæg/tråde/kommentarer i ALLE kanaler.
 ...
 * Output: scripts/discord/.sweep-2026-08-03.md
 */
...
const SINCE_ISO = '2026-07-27T00:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-08-03.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-08-03 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO} (sidste 7 dage, ejer-request)\n\n`;
