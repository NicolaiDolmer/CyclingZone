 ...
 * Output: scripts/discord/.sweep-2026-07-23.md
 */
...
const SINCE_ISO = '2026-07-19T00:00:00';
const OUT = path.join(process.cwd(), 'scripts', 'discord', '.sweep-2026-07-23.md');
...
async function main() {
  ...
  let out = `# Discord sweep 2026-07-23 — "Cycling Zone" (${GUILD})\nSince: ${SINCE_ISO}\n\n`;
  out += `## Kanal-inventar\n`;
