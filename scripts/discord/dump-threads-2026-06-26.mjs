#!/usr/bin/env node
/**
 * Sweep 2026-06-26. Dumper "siden sidst" = nyere end forrige behandlede tråd.
 * Forrige sweep (.new-threads-2026-06-25-pm.md) dækkede frem til tråd
 * 1519774212250665000 (2026-06-25 18:40) og filed via .file-issues-2026-06-25-pm.mjs.
 *
 * Kanaler:
 ...
 *
 * Token fra env; aldrig printet. Output: scripts/discord/.new-threads-2026-06-26.md
 */
...
const CUTOFF_THREAD = 1519774212250665000n; // sidste behandlede 2026-06-25 18:40
const SINCE_ISO = '2026-06-25T18:40:00';
...
async function main() {
  ...
  let out = `# Discord-sweep 2026-06-26 — siden cutoff ${CUTOFF_THREAD} (2026-06-25 18:40)\n\n`;
  ...
  const file = path.join(process.cwd(), 'scripts', 'discord', '.new-threads-2026-06-26.md');
