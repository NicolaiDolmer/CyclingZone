...
| 4 | **GitHub Projects v2 board** | Claude (gh CLI + GraphQL) | ✅ LIVE 2026-05-10 | [`CyclingZone Roadmap`](https://github.com/users/NicolaiDolmer/projects/2) (#2) — 5 kolonner: 📋 Backlog · 🟢 Ready · 🟡 In Progress · 🔵 Review · ✅ Done. Auto-add: aktivér engangs i UI på `/workflows` |
