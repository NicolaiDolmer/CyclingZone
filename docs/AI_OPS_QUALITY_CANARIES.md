...
| 6 | AI bruger ikke "Closes #N" i commits — bruger `Refs #N` og lader brugeren lukke direkte (`claude:done` label er valgfri som mellem-state) | `feedback_github_close_protocol.md` | — | ⚪️ |
