...
- **Economy:** 800K initial balance, division-scaled season-one sponsor (D1 600K / D2 400K / D3 260K, E2 strict_fair_v1), variable sponsor from season two, salary at 6.7% of market value frozen at signing, interest/payroll processing, loans, finance ledger, forecast, and risk tiers.
