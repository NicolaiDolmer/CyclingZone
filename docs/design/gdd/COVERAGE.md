...
| G07 | Akademi, ungdomstrupper, karrierer og generationsskifte | YOUTH_RULES; RIDER_GENERATION; PROGRESSION_RULES | YOUTH_RULES læst; ingen samlet kodekontrol |
| G08 | Kalender, udtagelse, kapacitet og sæsonplan | CALENDAR_RULES; PLANNING_CENTER_RULES; ASSISTANT_RULES | Inventeret |
| G09 | Taktik, roller, løbsmotor og sportslig troværdighed | RACE_ENGINE_RULES | Inventeret |
