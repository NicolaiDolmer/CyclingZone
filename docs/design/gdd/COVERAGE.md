...
| G03 | Besøgskadence, offline-spil, deadlines og assistance | ASSISTANT_RULES; PLANNING_CENTER_RULES; TRAINING_RULES | D-004/D-006: 2-3 besøg på 15-20 min; ASSISTANT_RULES §0-2 læst; E-001; D-007 om markedsaktivitet; D-034 (sen udfyldning 24t + påmindelse); D-037 (første session mål inden for 20 min) |
...
| G08 | Kalender, udtagelse, kapacitet og sæsonplan | CALENDAR_RULES; PLANNING_CENTER_RULES; ASSISTANT_RULES | Inventeret; D-034 (assistentens sene udfyldning af udtagelsen); D-037 (første session kræver egen udtagelse til næste løb) |
