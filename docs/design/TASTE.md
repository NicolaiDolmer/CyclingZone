...
- **Spørgsmål:** Kan spilleren udføre sidens primære handling på 375 px UDEN først at åbne "Fuld tabel", og står sidens tre vigtigste kolonner i standardtilstanden uden vandret scroll, med resten et tryk væk?
