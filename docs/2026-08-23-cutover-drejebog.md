...
4. **Generalprøve LØRDAG 22/8 (ejer-godkendt 20/8):** hele søndagskæden køres mod staging i rækkefølge med stopur: (a) frys snapshot + verificér backup, (b) race-day-flip, (c) post-verify `seasons.race_days_total` MATCHER kalenderen — efter kalender-GENOPRETNINGEN 21/8 (#4075: rent katalog, alle 28 datoer 25/8-21/9 har løb) er det **28** (recompute kørt og verificeret 21/8), (d) D1-komprimering mod dry-runnet, (e) mandat-backfill (lukker samtidig hullet "script-apply med ejer-nøgle"), (f) løn-genberegning med NY formel + stikprøve på 5 hold, (g) rollback-test af mindst ét trin, (h) notér samlet tid + mål 22-tickets adfærd. Generalprøvens målte tid justerer søndagsplanen.
6b. **REVISION 21/8 (#4075, kalender-genopretningen):** kalenderen fra 20/8 var bygget på et forurenet katalog (158 rækker mod CSV'ens 140; alle 3 GT'er dobbelt i D1). Hele S3-kalenderen er wiped + regenereret 21/8 fra rent katalog: 471 løb, D1 = 33 løb med præcis 3 GT'er (18/17/17), monumenter på egne løbsdage (100000-sentinel fjernet, #4075/B2), `race_days_total` = **28** (alle 28 datoer har løb nu). Snapshots: `docs/snapshots/3546/wipe-snapshot-season3-2026-08-21.json` + `docs/snapshots/4075/`. Første løb stadig TIR 25/8 kl. 11, 24/8 løbsfri. Søndagens program er UÆNDRET.
