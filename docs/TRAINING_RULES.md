...
- **Forlængelsen er alt-eller-intet (rettet 24/9).** Kan aftenens spænd inklusive forlængelsen ikke være under ops-loftet `MAX_GAME_DAY_CATCH_UP`, passer aksen ikke til målet, og forlængelsen droppes helt: aftenen kører præcis som uden den, og de droppede dage logges og returneres som `droppedExtensionGameDays`. Forlængelsen kan dermed aldrig skubbe dagens egne løbsdage ud eller ticke løbsdage kalenderen ikke har pakket.
