...
| 4 | **Præcis 140 tickede løbsdage pr. division (#4846).** Sæsonens første løbsdato starter på løbsdag 0; sæsonens sidste løbsdato forlænges til målet − 1 | `trainingDayCloseTrigger.js` (`loadPriorMaxGameDayByDivision`, `loadLastRaceDateByDivision`) |
...
- **Sæsonens sidste løbsdato.** Har divisionen ingen etaper efter i dag, forlænges spændet til sæsonens mål − 1 (læst fra `SEASON_RACE_DAY_TARGET`, løbsdag 139 i S4). Fejler opslaget, eller kan målet ikke læses, forlænges intet.
