...
| 7 | **Skadesvarighed i løbsdage. Præciseret af ejeren 21/9: 5-25 løbsdage i S4** | Det eksisterende skadesrul N skaleres med sæsonens løbsdagsakse divideret med antal løbsdatoer, læst fra `SEASON_RACE_DAY_TARGET` og `SEASON_RACE_DAYS_DEFAULT`. Ingen hardkodet faktor. Inklusiv slutdag giver præcis den skalerede varighed i UI, som også viser "ca. <dato>". Flag off beholder kalenderdage bit-identisk. Ejerens ord 15/9 var "Løbsdage"; "samme antal ticks" var konsekvenstekst og er afløst. |
