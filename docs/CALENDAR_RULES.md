...
|---|---|---|---|
| Løbsdatoer pr. sæson | **31** (S3: 28/8-27/9) | 25/8 | [#4215](https://github.com/NicolaiDolmer/CyclingZone/issues/4215) |
| **Løb hver kalenderdag** | **ingen løbsfri dage inde i sæsonen — i ALLE divisioner** | 25/8 | [#4215](https://github.com/NicolaiDolmer/CyclingZone/issues/4215) |
