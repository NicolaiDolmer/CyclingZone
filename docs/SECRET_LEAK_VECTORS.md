...
| Read tool på .env | `Read('.env')` (Claude Code's tool) | Ingen kendt | PreToolUse-matcher for Read kunne blokker — men Read er nyttig for `.env.example`. Sanitizer i AC2 fanger output istedet. |
