...
> **Historisk (arkiveret 8/9 2026, [#5048](https://github.com/NicolaiDolmer/CyclingZone/issues/5048)).** Afløst af [`docs/GROWTH_STACK.md`](../../GROWTH_STACK.md) (vækst og kanaler) og [`docs/MASTERPLAN.md`](../../MASTERPLAN.md) (den prioriterede kø); det brugbare er båret over (subreddit-kandidaterne r/procyclingmanager og r/peloton → GROWTH_STACK §5.6). Tal, priser og tiers heri er forældede. Den gamle sti `docs/strategy/TDF_2026_LAUNCH_PLAN.md` er en stub der peger herind.
