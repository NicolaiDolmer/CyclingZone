# CLAUDE.md (ARKIVERET 2026-05-06)

> **Erstattet:** GitHub-first start-rutine indført 2026-05-06 per [#70](https://github.com/NicolaiDolmer/CyclingZone/issues/70).
> Token-budget reduceret fra ~800-1500 til ~700 tokens cold-start.
> Aktiv version: `/CLAUDE.md` (repo root).
