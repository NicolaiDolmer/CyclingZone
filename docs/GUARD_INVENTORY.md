...
|---|---|---|---|
| League-size audit / GitHub CI | Ægte puljeoverskud; ny publisher og køens dry-run | 2026-09-10 (D4 F stadig 25 hold; ikke stale) | PR #5057: league-audit fejlede, mens et andet `audit` bestod. Prod D4 F havde 25 hold; branch protection krævede ikke league-checket, og merge-køen kontrollerede kun required checks. Alarmen blev ignoreret. #5066 er installeret. 9/9: ét trusted check på hver af #5070/#5071s præcise SHAs fandt D4 F = 25; køens dry-run stoppede med required=0, league=1. 10/9: en PR-kommentar kaldte fundet "stale-rødt" — read-only re-tjek (Supabase) viser D4 F fortsat 25 hold, plus 14 hold uden `league_division_id` (uden for checkets scope). [Bevis](audits/2026-09-09-4753-bootstrap-release.md). Checket er stadig ikke required; GitHub-protection og reparation afventer særskilt ejer-go. |
...
| CI | [.github/workflows/league-size-invariant-audit.yml](../.github/workflows/league-size-invariant-audit.yml) | audit: league-size-invariant | 2026-09-09: trusted publisher på almindelig PR og Dependabot; reelt overskud målt, kø-dry-run blokerede. 10/9 re-tjek: D4 F fortsat 25 hold, ikke stale. [Bevis](audits/2026-09-09-4753-bootstrap-release.md); branch protection afventer ejer-go. |
