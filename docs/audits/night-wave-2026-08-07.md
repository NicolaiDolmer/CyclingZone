...
| PR'er åbnet / merged | 14 / 13 (1 draft afventer ejer-go: #3539; #3498 gav bevidst INGEN PR, se nedenfor) |
...
- **Ekstra (proaktiv-mandat):** #3300 akademi-badge på træningssiden (PR #3539, draft til ejer-go) · #3498 admin-UI-oprydning: evidensbaseret gennemgang fandt INTET beviseligt dødt (17/7-oprydningen holdt; alle ~100 admin-kald matcher eksisterende ruter) — ingen PR, A/B-beslutning + støj-kandidater i issue-tråden
