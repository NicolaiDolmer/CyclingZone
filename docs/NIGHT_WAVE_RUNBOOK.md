...
- **PR'er oprettes som draft og markeres ready til sidst** (CodeRabbit-attempts, 7/9) — undgår at hvert wip-push tæller som et CodeRabbit-review-forsøg. FØR `gh pr ready`: kør `coderabbit review --base main --committed` (CLI, egen kvote, ~2,5 min), ret ægte fund, afvis støj med begrundelse i rapporten (#4991).
