...
- **Economy-konstanter** (backend SSOT: `backend/lib/economyConstants.js`):
  ...
  - **Akademi (#1308, cutover ved relaunch 2026-06-20):**
    ...
    - **8-plads akademi-cap håndhæves på ENHVER akademi-tilføjelse** (signering / [Fase B: auktionsgevinst / fri-agent-signering]). Backend returnerer 409 hvis `academy_count >= 8` på holdet.
