...
> **🎯 Next action:** **Start sæsonstart-master-sessionen** — prompt: [`superpowers/plans/2026-08-28-saesonstart-planlaegning-master-session-prompt.md`](superpowers/plans/2026-08-28-saesonstart-planlaegning-master-session-prompt.md). Fire spor: **A** holdudtagelse (#4295 · #4299 · #4201) + **D** formplanen (#4294 · #4212 · #4293 · #4271) FØR kl. 11 · **B** overlap-læsbarhed (#4296 · #4259 · #4245 · #4165) · **C** Z1-sæsonmatrixen (#1146, aksen er fri). Fredags-blokken leveret: **#4284 · #4285 · #4286 · #4291** merged 27/8 morgen. Rest på ejeren: apply #4284s migration · §6-tjeklisten (query 3 kl. ~10:15) · **post svar-udkastene i Discord** (`docs/drafts/2026-08-27-4261-svarudkast-loeb-som-traening.md`) · **PR #4298** (backend-only, CI grøn).
