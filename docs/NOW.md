...
> **🎯 Next action (ejer):**
> 1. ✅ Discord-besked om mandag-aften-tiderne POSTET ~17:00.
> 2. ✅ **[#2851](https://github.com/NicolaiDolmer/CyclingZone/issues/2851): endelig 48/96/12-liste genereret 19:0x og EJER-GODKENDT ~19:15** (alle 423 S1-løb verificeret completed; cutline-144 = 61-61 afgjort, countback dokumenteret på issuet; opfølger #3036). Cutover-sessionen re-kører dry-run og diff'er mod den godkendte liste FØR "Afslut sæson".
> 3. **Efter cutover (Claude kører):** honours-SQL (`database/2026-07-26-2863-season-honours.sql`) · achievements-backfill (EFTER op/nedrykning) · ryd 91 S2-peaks · verificér `AVG(fatigue)=0` · #2894/#2902-backfill (1.326 ryttere) · verificér at scout-varsler LANDER (#3016-migrationen ER applied 26/7 13:56 med post-verify; `season_transition_risk` er BEVIDST udeladt — koden bruger `contract_expiring` efter PR #3026, så "manglende type" er korrekt tilstand, IKKE en fejl) · luk 7 gated done (#2589 #2744 #2745 #2835 #2894 #2902 #2925).
...
> **🤖 Working agent:** ⚠️ CUTOVER-SESSION AKTIV (startet 26/7 19:35, ejer-go 19:15) — kører S1→S2-skiftet per SEASON_TRANSITION_CHECKLIST. RØR IKKE prod/DB/flags fra andre sessioner før denne er meldt færdig. 26/7 ~17:15: #3030 hotfix SHIPPED+verificeret (auto-prize-sweep død på .in()-URL-grænse; 688.200 CZ$ udbetalt 15:03 UTC, Sentry 3H/3G/2G resolved, PR #3031). Nyt: #3032 (scouting-notifikationsfejl, Sentry 3F, 5 brugere). 18:15-18:41: **Supabase RAM-incident** (Micro-instans tør → 522 på auth+REST); ejer opgraderede Micro→Small (2 GB), alt verificeret oppe 18:41 (0 overdue auctions/DMs), 12 Sentry-fallout resolved, opfølgning #3033-#3035, postmortem i `.claude/learnings/`.
