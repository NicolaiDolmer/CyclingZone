...
> **🎯 Next action (21/9 aften):** **Rækkefølge ejer-godkendt 21/9 (MASTERPLAN øverst).** **A · ejerens hånd:** post catch-up v7.284-7.292 (#5429, kun EN) · "merge" #5169 (grøn; virker først ved S4-generering) · flip `training_score_visible` + udmelding · Android-test → flip `training_mobile_table` → slet gammel gren (#3643) · win-back #2760 inden 24/9. **B · Claude:** 6 **værdiskiftet #5443** (kode merget #5446, begge kontakter v4, intet tændt; mangler patch notes + help.json; ÉN kørsel på ejerens "kør", løn efter skiftet) · 7 **S4-kalender #5405** (efter #5169: tørkørsel UDEN `--uniform-tilt` → `--apply`, go pr. kørsel) · 8 flip-dag 28/9 (`training_tick_per_race_day` + `race_day_development_enabled` + #5281) · 9 /roadmap #5387. **Derefter:** roadbook-løfterne 15/9 (masterplan-artifactet); ejer-kort om de ikke-startede udestår. **Codex-lane:** forum-links #3517, rør ikke forum-filer. **PR'er:** #5169 #5281 #5444 #3512.
