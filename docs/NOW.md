...
>
> **✅ [#2521](https://github.com/NicolaiDolmer/CyclingZone/issues/2521) (agent-worktree, løsning A):** Sæson 1/baseline-bestyrelsen deltager nu i weekend-opdateringen (percentil blandt rigtige hold i puljen + økonomi), klampet 30-75; budget_modifier + hårde konsekvenser uændret (fortsat skippet for baseline). Dry-run-scorecard i PR-body.
