...
1. **Brug AI_OPS_DISABLE_PLAYBOOK** — disconnect ubrugte MCP-connectors via claude.ai/settings/connectors; disable ubrugte plugin-skills via `/plugin`. Mål: cold-start <8K tok.
2. **[#334](https://github.com/NicolaiDolmer/CyclingZone/issues/334) implementering** — Phase 0-1: P95 baseline + Redis-backed rate-limit.
