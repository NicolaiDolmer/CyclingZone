...
> **🤖 Working agent:** Codex: GDD-interview 10/9. Branch `codex/game-design-document`; [GDD](GAME_DESIGN_DOCUMENT.md), [journal](design/gdd/SESSION_LOG.md). V-001/D-001–013 + R-001 (følge egen avl); Q-016 om opfølgning afventer. Ingen prod-ændring.
