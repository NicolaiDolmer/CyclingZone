...
> **🎯 Next action (22/9, reviewrettelser):** Ejer-review af #5465 (5-25 løbsdages tabt træning, rollback og migration), #5468 (ejerskab, resume og merge-lås), #5469 (kun godkendte finalejusteringer; 3 restlinjer, ingen apply) og #5470 (v7.293 for #5463/#5466/#5464). **Afhængigheder:** #5477 retter testens sprog-init; #5470 bygger på den. Udskilt kalenderforslag #5476 afventer ejerbeslutning. #5461 bruger v7.294 og holdes til kørselsdagen. Ingen merge uden ordret go; #5468 kun uden aktiv bølge, første bølge ét konkret docs-spor. **Derefter:** #5423 før **#5435 kun model A, ingen loft-tal**, så #3643 og /roadmap #5387. **Ejerens hånd:** værdi-udmelding → flip v5 → "kør" · Android-test · training_score_visible + udmelding · win-back #2760 inden 24/9. Flip-dag 28/9: #5281/#4849.
