...
> **🎯 Next action (ejer-besluttet 2/7 eftermiddag):** (1) **EJER MERGER [#2091](https://github.com/NicolaiDolmer/CyclingZone/pull/2091)** (overlap-guard — [#2090](https://github.com/NicolaiDolmer/CyclingZone/issues/2090): 10 etaper kørt FØR scheduled_at, bl.a. Volta Algarvia st2-3; resultater lades stå). (2) **#2072+#2081 GC-fix I DAG** — ny session/worktree, akkumulér GC fra persisterede race_results + persistér klassementer pr. etape; SKAL være live før Volta Algarvia finaliserer 4/7. (3) **#2000 rytterside-faner (PR #2037) færdige senest 3/7.** (4) #2080 kampagne-drafts + #2079 attribution før 4/7. P0 #2071 LUKKET (1,69M udbetalt, rangliste frisk); patch note v6.41 live + Discord-notat postet (ejer-godkendt tekst). Beslutnings-dag 6/7: Alunta/CZ Pro + VMan + Discord-migration + trænings-scorecard (#2082: harness 5/7, ship 7-9/7; **ejer-mål: ~50 % af gap på 5-7 sæsoner, peak 27-28**). Marketing: ~10k DKK juli, 2026 maks 50k (Meta/Reddit/Google) — først når #2079 måler. Kill-liste eksekveret (−53; #671+#680 undtaget). Discord-posts kræver ALTID ejer-godkendt tekst.
