...
> **🎯 Next action:** **Ejerens fredag-morgen-rutine (28/8, sæsonstart kl. 11).** Rapport: [`docs/audits/2026-08-28-natsession-rapport.md`](audits/2026-08-28-natsession-rapport.md). Rækkefølge: review+merge **PR #4284** (din egen) → **#4285** (#4200: ryddet trup bliver ryddet) → **#4286** (#4233: D4-A står på 25, nye signups fredag) → apply #4284s migration → §6-tjeklisten (query 3 **kl. ~10:15**). Også klar: **#4287** (Hjælp, 5 spillere venter) · **#4289** (CI) · **#4290** (kalender-vagter). Alle PR'er kræver din review — branch protection, ikke tøven.
