...
> **🎯 Next action (10/9 kl. 16:45):** Kør prompten `docs/drafts/next-session-prompt-2026-09-10-design-og-eksekvering.md` (ejer 10/9: kort design, derefter eksekvering til kunderne). **1) Go-kort + merge** på bølgens tre draft-PR'er: #5097 chunk-fejlens rod-årsag (egen `preventDefault()`, 99,5 % af Sentry) · #5100 rytterkortets 14 kald/rytter → 429 · #5099 mobil sticky rytternavn (ejer tjekker Android). Eneste røde check = feature-liveness (#3069, kendt rødt på alle PR'er). Reviewer-fund er rettet i samme worktrees (`C:\Dev\CyclingZone-worktrees\`); én fix-agent kørte stadig ved close-out, tjek `gh pr checks` + journal `wf_53ae5095-661`. Patch note v7.268 samlet når de er merget. **2) Docs:** #5071 (rebaset uden NOW.md, klar) · #5090 GDD (preflight grøn; META_DOCS_INDEX-linje + hard rule 30 #5058 før merge). **3) Design (kort):** personale-/løbsomdømme (`REPUTATION_RESEARCH.md` §4), popularitet → omdømme (D-042 forudsætning). **4) Derefter:** #4983 påmindelse før udtagelsesfrist (D-034) · #5073 pensionsvarsel rod-årsag · #4872 holder fixet? · bane 1 (#4845 → #4270, #4850-pakken). **Ejer-trin:** post fog of war-afstemningen (`docs/drafts/forum-poll-fog-of-war-2026-09-10.md` + PNG) · skema-reminder (luk ved 40 eller 15/9) · #4346 anmeld-handel (lovet 27/8) · flyt forumkategori ("senest 10/9") · nøgler (PostHog, GSC, Resend-webhook, EUR-testkøb, `AUTO_MERGE_PAT`, `SUPABASE_ACCESS_TOKEN`). S3 slutter søndag 27/9, S4 starter mandag 28/9.
