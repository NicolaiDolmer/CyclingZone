...
> 3. **buildSeasonEndPreviewRows i frontend er nu misvisende** ([SeasonEndPreview-komponenten](frontend/src/pages/AdminPage.jsx)) — den viser stadig "salary_deduction" + "next_season_sponsor" som om de skete ved sæson-slut. Skal opdateres til at vise dem som "sæson-start-payroll" for kommende sæson. Lav som sub-issue til v3.78.
