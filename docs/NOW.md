...
> **🤖 Working agent:** Codex: GDD-interview 10/9. Branch `codex/game-design-document`; [GDD](GAME_DESIGN_DOCUMENT.md), [journal](design/gdd/SESSION_LOG.md). V-001/D-001–015 + R-001; Q-018 om prioritering afventer. Hold kort åbent indtil svar. Ingen prod-ændring.
