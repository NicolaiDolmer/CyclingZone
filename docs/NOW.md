...
> **🔴 Platform:** Prod 191 brugere, 54 aktive sidste 7 dage. **Dag-1-retention ~31 % seneste 2 uger (var ~64 % i juni) — last_seen-metode; event-tallene (19-24 %) var consent-forvrængede, korrektion 4/8 i #3310.** #2853 venter på Resend-nøgle. #2736 Alunta-cron: første kørsel ~23:49 4/8 (tjek næste nat; fornyelse 31/8). Railway MCP kræver re-auth (interaktiv session). Playwright mobile-webkit lokalt = miljø-issue, CI gater. ~~Lokal main-checkout hænger~~ **ryddet 4/8: main = origin/main, 11→2 worktrees, 97→3 lokale branches.**
