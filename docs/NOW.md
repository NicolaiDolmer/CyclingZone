...
> **📌 Opfølgninger:** kalibrerings-session efter cutover: #3719/#3720/#3987/#3732/#2650 + #4059 (skarpe-dage-seed-skævhed, bekræftet 21/8) + D1-løn-sats + #3966-bånd · #3347-scorecard NO-GO for D2/D4 (katalog-bundet, interim) · W8 bundt 2 · #4001 · miljø-audit + #691 uge 35 · #3952/#3982 visuals · #4037 · `ceilingBandInversion.test.js` rød lokalt (CI grøn) · #4073 (lav) · team-orders-whitelist BLIVER (verificeret 22/8: kortet er merged, men `tacticsOrdersAdapter.js` mocker stadig — fjern først når adapteren fetcher rigtigt) · **#3448-anker pushet som backup** (`feat/3448-level-anchor`) — PR først EFTER værdi-overgangen, rører samme kode; `a_floor_shift` står i config på main men læses ikke af nogen kode · wire `cleanup:worktrees` op som scheduled task (findes, køres bare aldrig; 63 branches ryddet 22/8, 211→148). Ved hver kørsel: kig på de worktrees scriptet SPRINGER OVER pga. ucommitted — 22/8 lå 730 linjer #3337-harness der uden backup (nu `measure/3337-specialisering`).
