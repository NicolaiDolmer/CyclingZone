...
> 1. **🔴 Fundament-programmet (6/8): ALLE retnings-beslutninger truffet — specs klar til endeligt "godkendt":** [#3295](https://github.com/NicolaiDolmer/CyclingZone/issues/3295) S3-kalender = **K-B besluttet** (flad 24/kuperet 30/bjerg 28/ITT 8/brosten 6/TTT 4; TTT-motor-verifikation før løfte) → [#3458](https://github.com/NicolaiDolmer/CyclingZone/issues/3458) typefordeling afledt af K-B (research: PCM/FM-emergent-princip; specialiserings-dybde i dag = 0) → [#3459](https://github.com/NicolaiDolmer/CyclingZone/issues/3459) løbsdags-model (racing +10-20 %, live 23/8). Kritisk sti: kalender-generator mod K-B → S3 materialiseres FØR 23/8. **Spillerkommunikation #3372 PARKERET til fundament-fase 1** (peak-talent bevaret-måling klar som kerne). #3441 shippet (v7.101); #3442 afkoblet.
