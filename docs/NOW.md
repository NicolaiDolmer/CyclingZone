...
> **⚖️ Fair play:** #3818 afgjort + #4166 lukket som dublet 24/8 (clawback + frys + auth-ban + advarsel; #4154-skabelon). Tekst: `docs/discord/2026-08-24-svarudkast-fairplay-3818.md`. **Ejer: prisloft sættes IKKE** → #3138 eneste værn; rest i MASTERPLAN E14. Løs ende: Wheelbarrels banned uden Discord, uden forklaring.
