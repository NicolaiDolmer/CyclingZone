...
> **🎯 Next action (ejer):** (1) **🔴 Auktions-close I AFTEN ~22:53 [#2754](https://github.com/NicolaiDolmer/CyclingZone/issues/2754):** beslut nerf/behold (#2699) + bud-politik (community kræver reset ved nerf, Discord 19-20/7) + verificér #2701 YTH-guard FØR luk (59 auktioner, backup `backup_auction_push_24h_20260719`, patch 7.32). (2) **📈 Growth-sprint 20/7:** godkend 3 e-mail-tekster (PR #2728-body / chat) + RESEND_API_KEY+EMAIL_UNSUB_SECRET i Railway → flip `email_loop_enabled` off→dry_run→on · Alunta-config + testkøb (#1903) · Hattrick/bølge-2-udkast på [#2236](https://github.com/NicolaiDolmer/CyclingZone/issues/2236). (3) **👍/👎 [#2639](https://github.com/NicolaiDolmer/CyclingZone/issues/2639)** trim 7 D4-AI-hold — **blokerer nu audit-checket på ALLE PR'er** (#2728 krævede admin-merge). (4) **Sæsonskifte 27/7** (#2449 S2-kalender LIVE, 455 løb): S1→S2-audit 20/7 shippede 3 hærdnings-PR'er (#2741 rækkefølge-guard+copy-fix, #2734 progression-atomicitet, #2735 faldskærm #1980 done) + begge migrationer applied+verificeret. **27/7-blockere: [#2755](https://github.com/NicolaiDolmer/CyclingZone/issues/2755)** S2-kalender-rebalance (community-audit 20/7: D3 skævvredet) FØR [#2742](https://github.com/NicolaiDolmer/CyclingZone/issues/2742) (S2 har 0 race_entries → pre-generér før cutover). Audit-rest tracket: #2742-#2749, #2751-#2753 + nye 20/7: #2756 kalender-UX, #2757 pointtrøje. Kør transition #2361 ~27/7 (nu gated: kør "Afslut sæson" FØRST). (5) Åbne ejer-beslutninger: #2699 akademi-overflow (sim klar) · #2589 sponsor-divisor · #2697 scout-slot · #2670 ROI-loft · #2452+#2176 når v4-adfærd kan måles. (6) AI-audit [#2689](https://github.com/NicolaiDolmer/CyclingZone/issues/2689) (#2679/#2681/#2682; klik: #2680). (7) Supabase-audit: [#2677](https://github.com/NicolaiDolmer/CyclingZone/issues/2677) RLS-perf · [#2678](https://github.com/NicolaiDolmer/CyclingZone/issues/2678) matview · #929/#2258 OTP+leaked-pw (2 dashboard-klik) · #2259 backup-oprydning.
