...
> **🎯 Next action:** **Ny session designer den store natbølge**: læs `docs/drafts/natboelge-oplaeg-2026-09-03.md` + [pengeplan §3-§4](superpowers/specs/2026-09-02-30-dages-pengeplan.md). **Natbølge 2/9 leverede:** merget #4652 #4653 #4655 (done #4644 #4648 #2816, patch note 7.237); drafts til ejerens visuelle go: #4654 mail v2 · #4657 design-kit · #4662 Pro-fordele (2 migrationer, 3 ejer-spørgsmål) · #4661 årsmøde-frontend · #4659 SEO · Tilmeld-knap #4592 (branch `feat/4592-season-signup-button`) · #4656 årsmøde backend (migration = ejer-GO) · #4608 EUR-checkout rebaset og grøn (merge lige efter nøgleblokken #4616; patch note → 7.238). **Morgen (ejer, 30 min):** drafts-go → merge-runde (`--admin` når CI grøn) → migrationer applies af Claude (GO) → nøgleblok #4616 → dry_run #2853 (GO) → faktura #2 (61,25 kr) ubetalt hos Alunta. **Hårdt:** S4 findes ikke i `seasons`; skal materialiseres før årsmødet virker (#4176/#4270). Mandagstal (§0.9) man 7/9 kl. 09; målt 2/9 kl. 21:30: MRR 188,40 kr / 5 abo, checkout 4 af 7, D7 18 %.
...
> **🤖 Working agent:** **Session B (ny, 2/9 ~23:05)** designer den store natbølge og må claime frit. Session A lukker ~23:30 og rører kun worktree `feat-4592-season-signup-button` + `docs/audits/night-wave-2026-09-02.md`. Playwright-slottet er frit. Fable = arkitekt, workers = Opus/Sonnet med `model` sat eksplicit.
