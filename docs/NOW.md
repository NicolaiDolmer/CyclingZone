...
> **🎯 Next action:** (1) **#4170 tomme løb** — **157 af 471 S3-løb (33 %) har nul entries**, 27 puljer provisioneret til 8 instanser hvor ~2 bruges. Strukturelt, ikke #4163-efterslæb (målt efter rent tick). 12 af dem starter i morgen 25/8 kl. 11 som tomme 4-etapeløb → beslut FØR da: slet tomme instanser nu, eller ret sizingen. **#4161** (D1 kræver op til 29 ryttere på én dag, 4 samtidige løb) hører til samme klynge — samme rod-mistanke: sizing efter komprimeringen. (2) **#4159** forward-guard (DB-trigger + lane-packer-fix + transition-gate; fjerde vagt: assertér constraint-FORM, ikke eksistens) — FØR næste kalender-generering. (3) Ejeren poster: forum-indlæg + Fakta-DM (sidste advarsel) + community-linje (udkast leveret 24/8-natten) + **staff-chat-svar #3818** (bobby/friisisch spurgte 24/8, intet svar givet). Derefter/parallelt: v4-afvigelser (gate RØD, #4132; tirsdag kører v3) · **#3512** først i rytter-pakken (rebase+verify) · #4098/#4128 · kalibrering (#3719 præmier pr. division, **#3720 upkeep-kurven** — S3 kørte HALVERET 220k/70k/20k/0, ejer 23/8; S4-satser sættes i #3720 — #3987, #3732, #4059) · #3121 matview-sæsonfilter · MAN-ugenote (#428) + svar (skader nulstilles IKKE; form decay 25 %; cybersimon #4044; D1-upkeep #4125 + forecast-dobbelttælling #3986; egomadsens 0/8→0/12-bestyrelsesmål + bonustilbuds-spørgsmål) · /pro (#4074) · forecast-verify · slet staging `staging-cutover` (#3839) · worktree-hygiejne · friktion: auto-mode-classifier blokerede endSeason/transition-dry-run 23/8 aften (løst m. detached Start-Process), remeasureGate3459 validerer ikke sæsonargument; **Railway-MCP's token udloeb midt i en prod-verifikation 24/8 — skal godkendes igen i en interaktiv session.**
...
> **🤖 Ingen aktiv session** (24/8: triage-, ugescan- og nat-sessionerne lukket ~10:30; #4163 løst+verificeret 2 gange uafhængigt, #4170 udskilt, #4160 oprettet, #3818+#4154-sanktioner eksekveret — ejer-GO pr. prod-skridt hele vejen. **Delt checkout skiftede branch uden varsel** — verificér ALTID branch før commit. `staging-cutover` BEHOLDES til #4159-guard-test; #3839 venter).
