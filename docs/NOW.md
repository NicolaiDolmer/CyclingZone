...
> **🎯 Next action (21/9, Codex close-out):** Ejer-review pr. PR, intet merget af Codex. **#5468:** PR-loft 8 + interaktiv ejer-recovery klar; merges ikke i aften, kun uden aktiv bølge og efter ordret "merge". Første bølge derefter: ét ufarligt docs-spor. **#5405 / PR #5469:** tørkørsel uden regel-/placeringsbrud, ingen apply; ny kørsel kræver ejer-go. **#5465:** ejerens skadesrettelse + rollover/fallback-rettelser pushet efter 5f420a786; flag off bevaret. **v7.293:** samlet note for mergede #5463, #5466 og #5464 i denne PR; #5461 rykker til v7.294. **Derefter som bestilt:** #5423 før #5435, så #3643 og /roadmap #5387. **Ejerens hånd:** værdi-udmelding → flip v5 → "kør" (#5461) · Android-test · training_score_visible + udmelding · win-back #2760 inden 24/9. Flip-dag 28/9: #5281/#4849.
