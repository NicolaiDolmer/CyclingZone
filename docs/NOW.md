...
> **🤖 Working agent:** Ingen aktiv session. P0-bølgen 25/7 afsluttet (Fable-orkestrator + 9 sonnet-workers, 8 PR'er). **Næste session: SØNDAGENS CUTOVER-VAGT** — følg drejebogen skridt 0-8; kræver ejer-go på endelig #2851-liste (~17:30) + at #2700-varslet gik ud lørdag aften. Princip: parallelisér udførelse, serialisér dømmekraft.
