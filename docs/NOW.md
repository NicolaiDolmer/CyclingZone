...
> 3. **Økonomi-designoplæg afventer dit valg af retning** (se #3360-tråden ovenfor). Ejer-retning 5/8: penge skal være en begrænsning **hele vejen** — færre garanterede penge, flere udgifter, dyrere vedligehold jo bedre ryttere, sign-on-gebyrer, forlængelsesomkostninger. Gaten inden kode: skal eksisterende kontrakter genberegnes ved en lønsatsændring, eller kun nye? (Løn er frosset ved signering, #1309.)
>
