...
> **⚖️ Fair play — sanktions-præcedens:** **#4154** og **#3818** (eksekveret 24/8) behandlet ENS: clawback af funnel-kontoens bruttobeløb, køber beholder rytterne, funnel frosset + auth-banned (`banned_until` 2126-01-01), sidste advarsel til modtageren in-game. #2221 var kun frysning. Skabelon + tal: PR #4168 + issue-tråde. **Ejer 24/8: `transfer_price_cap_multiple` sættes IKKE** → mønsteret kan gentages, #3138-detektoren er eneste værn (den rangerede #3818 som nr. 13/23). Løs ende: Wheelbarrels er banned uden Discord og har fået **ingen** forklaring (ejer: ingen e-mail nu).
