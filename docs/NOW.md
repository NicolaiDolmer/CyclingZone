...
> **✅ 20/8 dobbelt-instans LUKKET** (#4026 → #4027, 7.163): etape-claim skibet (migration applied), Railway ryddet (én instans), CodeQL #186 fixet. NB: `ceilingBandInversion.test.js` rød lokalt også på main (CI grøn) — kalibrerings-sessionen.
...
> **📝 PR #2748** (pension-minimum: rytterprofil-banner + indbakke-varsel) bærer patch note **v7.161** (main's top var 7.157 ved merge; 7.158-7.160 reserveret til andre PR'er i aftenens merge-tog).
