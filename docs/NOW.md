...
> **🎯 Next action: [#2463](https://github.com/NicolaiDolmer/CyclingZone/issues/2463) board-generalprøve** (afblokeret 16/7 — #2482/#2473 merged; ejer-go 16/7: "tag den når relevant" — kør FØR sæsonskiftet, gerne næste session) → derefter #2361 sæsonritual → #2449. **Merge-salven 16/7 GENNEMFØRT:** 16 PR'er merged (begge bølger), 3 migrationer applied (orphan-guard #2481 · why-moments #2355 · dismiss #2455), 5 AI-overskudshold markeret (sweepen trimmer til 24/24/24 — verificér). Rest: #2472-taper (scorecard → ejer) · #2498 patch notes (v7.01+v7.02 + 3-4-dages-sweep, merge SIDST) · Discord-announce (ordret ejer-godkendelse) · CI-hærdning #2511 (required checks — afventer eksplicit ejer-sætning) · #2433 shadow merged.
