...
> **Næste session starter med:** Læs `AGENTS.md`, `docs/GUARDRAILS_CORE.md`, `docs/NOW.md`, `docs/MASTER_PLAN.md` og `docs/decisions/session-c-discord-validation-loop.md`. Hvis Nicolai har postet Discord-loopet, opdatér `docs/SPRINT_DASHBOARD.md` Week 1 checkboxes + tidlige metrics. Ellers tag **Session E: #479 mobile performance triage** (Codex eller Claude Code) for at sikre `/founder-supporter` ikke er flaskehals før bred recruitment.
