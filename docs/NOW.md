...
>
> **TdF-vinduet 4/7:** kampagne [#2080](https://github.com/NicolaiDolmer/CyclingZone/issues/2080) + attribution-fix [#2079](https://github.com/NicolaiDolmer/CyclingZone/issues/2079) (UTM død siden 15/6) FØR første post. Ejer-klikliste: #2076 uptime · #2085 mail-kapacitet · #1784 spend-cap · #929 · #2092 RAILWAY_TOKEN · `railway login` · Alunta-tokens.

> **🎯 Next action:** (1) **#2080 kampagne-drafts + #2079 attribution før 4/7** (marketing; ejer-godkendt tekst). (2) **#2081-rest** (staged reveal · holdfilter · top-10/"se alle") + luk #2072 efter GT-verify. (3) **Scouting-fane** (#2000-epik rest) + capstone/loft #2100. (4) #2082 trænings-scorecard (harness 5/7, ship 7-9/7; mål ~50% af gap på 5-7 sæsoner). (5) **#1972 backup-drop** ejer-gated på race-uge-stabilitet (ready SQL i issue-tråd). Shipped 3/7: #1936 (træning-tick-kommunikation) · #1667 (admin edition_year-cleanup) · #2083 (akademi-løn ensrettet til fælles rate + genberegning APPLIED, −21.901 CZ$, backup_academy_salary_2083_20260703) · #2137 (akademi-roster-redesign: samlet tabel + filtre + Acad-badge, #1929) · glemte patch notes (#2143). On-page patch notes komplette. **Beslutnings-dag 6/7:** Alunta/CZ Pro + VMan + Discord-migration. Discord-posts kræver ALTID ejer-godkendt tekst.
