...
> **⏳ Åbne ejer-valg (ét ad gangen):** #4270 kalender (frist 10/9) · **#4860 sponsor: S4-tilbud prissat mod tom S3-standing, 30 hold på 1,00 (≈3,0 mio.), A genpris ved aktivering / B sidste afsluttede sæson, FØR 27/9** · #4616 EUR-nøgler (30 min) · #4915 TTT · #4948 raceDay-hjælp · #4964 launch-kohorte · #4857 mandat-backfill · #2423 skew (rør ikke). Discord: patch-notes catch-up v7.256-7.262 (`docs/discord/2026-09-07-patch-notes-catchup-7256-7261.md`) + spørgeskema-post når det udsendes. Forum: "The future of:"-serien (staff + Pro postet 7/9; academy + race engine klar i `docs/drafts/forum-future-of-*.md`), ejeren poster selv og samler svar op.
