...
> **🤖 Working agent:** Codex, #4753, worktree `fix/4753-dead-offers-block-trim` (9/9). Design-go i ejer-chat: bevar historik, transaktionel markering/nedlaeggelse, sikker draening, pulje-sweep og bindende audit. Ingen prod-oprydning foer dry-run + separat ejer-go.
