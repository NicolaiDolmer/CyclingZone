...
## Aktiv slice
**Polish-sprint frem til open beta (#178)** — auktions-cluster (#192, #193, #194, #44) er shipped; mangler kun manuel verifikation på prod. Næste fokus: mobile UX + onboarding friction-audit. DX-laget er hærdet via #201.
