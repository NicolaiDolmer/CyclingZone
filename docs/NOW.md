...
>
> **🎯 Next action:** **13/7: verificér første v3-løbsdag LIVE** — runs stempler `engine_version=2`, DNF-rate i bånd (`race_incidents`), hjælper-tab synligt, Sentry ren; fjern `race_stage_roles` fra liveness-audit-whitelist når tabellen har rows. Næste Claude-session: **v3 S5 peak-planer** (spec §10). Ejer 13/7: Alunta+CZ Pro (#1903) · flip-bølge-verify (#2357) · /training-verify · 📌 ovenfor.
