...
> **🎯 Aktiv session:** **landing 1 ([#3666](https://github.com/NicolaiDolmer/CyclingZone/issues/3666) + [#2454](https://github.com/NicolaiDolmer/CyclingZone/issues/2454) + #3667 + #3671, ét deploy)** kører på `feat/3666-rating-skala-landing1` — prompt: [`rytterne-skal-kunne-stoles-paa`](sessions/2026-08-13-rytterne-skal-kunne-stoles-paa-prompt.md), to trin (landing 1, derefter positionerings-loftet). Halvbredderne er **målt + ejer-besluttet: `[9, 6, 4, 3]`** ([måling](https://github.com/NicolaiDolmer/CyclingZone/issues/3666#issuecomment-5283254052)). **⚠️ [#3679](https://github.com/NicolaiDolmer/CyclingZone/issues/3679): loft-båndet kan regnes ud af to scout-niveauer — 90-93 % pinnes til ±1 point PÅ MAIN I DAG**, og `scoutingInversionHarness` gatede aldrig loft-båndet (importerer det ikke, kørte ikke i CI). Gate R8 var trivielt opfyldt. Ny harness bygget.
