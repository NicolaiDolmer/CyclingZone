...
> **📦 Backlog-bølge 30/8 (autonom, afsluttet).** 19 issues leveret, 8 lukket som allerede løst, 3 nye oprettet (#4433 #4440 #4446). **8 PR'er merget selv** (CI-vagter, docs, dev-scripts). **10 venter på dig:** #4425 #4426 #4428 #4429 #4434 #4435 #4436 #4437 #4443 #4444, + **#4445 patch note 7.222 merges SIDST, efter #4413.** **Efter merge af #4443: apply `database/2026-08-30-2892-cron-heartbeat-checkins.sql`.** Screenshots i `pr-screens/wave-30aug/`. Ældre rest: #4390 #4392 #4399 #4413.
