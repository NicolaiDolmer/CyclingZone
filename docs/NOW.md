...
> 3. **🆕 Markedsdrevne værdier ([#3448](https://github.com/NicolaiDolmer/CyclingZone/issues/3448), ejer-retning 6/8):** #3393-valgene låst (0,55/fuld pris/23-8) + NY plan: 50/50-blend live SØNDAG 9/8, ugentlig søndags-kadence, 100 % ved sæsonskiftet. Model v1.1 fittet + konvergens simuleret (alt på issuet); implementerings-PR bygges (kill-switched off). **Ejer-valg udestår: ugentligt loft ±15/±25 (anbefalet)/±40 %** + go på søndags-tallene. ⚠️ SUPABASE_SERVICE_KEY bør roteres (subagent-lækage 6/8, hook-fanget — ejer-klik). **#2650:** K4 anbefalet, AI nu UNDER-træt (#3015) — valg udestår.
