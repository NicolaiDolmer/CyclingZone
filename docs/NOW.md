...
> **🎯 Next action:** (1) **#2612 (#2599) — merge + kør `race_entry_clears`-migration** (sidste bølge-PR; de 9 andre LIVE). (2) **Bølge-beslutninger:** #2600 sæson-0-DB-række behold/slet? · #2599 sweep-scope (indsnævre 8.841-entry-autofill?) · #2581 backfill 17 usøgbare · #2589 sponsor-slice (metode klar). (3) **Ejer-tests i prod:** /training · Global Rank · bulk-priser /transfers. (4) **S2-generering:** admin → Sæson → "Generér kalender" (dry-run FØRST). (5) Discord-announce 17/7-pakken.
