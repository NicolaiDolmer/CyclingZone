...
## Senest leveret
- 2026-05-15: **#332 restore-drill runbook** — `docs/RUNBOOK_RESTORE_DRILL.md` etableret med månedlig cadence (beta) / kvartalsvis (post-stable), PITR-baseret restore til separat non-prod project, smoke-tests A-D (auth, FK-integritet, spil-invarianter, backend), rapport-skema og provider-outage politik. Næste: planlæg første drill i kalenderen + opdatér #332 med acceptance.
