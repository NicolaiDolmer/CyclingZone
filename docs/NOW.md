...
> 2. 🔴 **Sponsorvalg 2.0 ([#2948](https://github.com/NicolaiDolmer/CyclingZone/issues/2948), [PR #2955](https://github.com/NicolaiDolmer/CyclingZone/pull/2955)) BYGGET 25/7** — 5 arketyper + bonusklausuler, #2913-enhed (pr. etape) + #2914-default (1 sæson) fixet, sim-guard grøn (Δ−2,1 %/+1,2 %), latent finance-type-CHECK-bug fanget (`sponsor_race_day` manglede). CI grøn + MERGEABLE — **afventer ejer-merge** (branch-policy; PR-klik i GitHub). Efter merge applier Claude migrationen (#2642) + flipper labels. **Ejer: klik sponsor-modalen igennem på prod før søndag.**
...
> 6. Ikke-cutover: #1903 Alunta-testkøb + #2806 `/pro` · e-mail-loop #2853 (3 tekster + 2 Railway-keys) · markeds-valg [#2884](https://github.com/NicolaiDolmer/CyclingZone/issues/2884)/[#2885](https://github.com/NicolaiDolmer/CyclingZone/issues/2885) · [#2905](https://github.com/NicolaiDolmer/CyclingZone/issues/2905)/[#2906](https://github.com/NicolaiDolmer/CyclingZone/issues/2906) planner-UX + Mit Hold.
...
> **🤖 Working agent:** 🔴 **AKTIV 25/7 aften — Fable-orkestrator, lørdagsbølge 3:** 12 kode-agenter i worktrees + 1 designrunde. Spor: #2912+#2919+#2920 gæld · #2924+#2921 cutover-oplevelse (draft, tekst ejer-gated) · #2925 kom-i-gang-kort · #2951 · #2952 · #2943 · #2945 · #2899 · #2882 · #2895 · #2898 · #2888+#2906 Mit Hold (draft) · #2905 designrunde (ingen kode). Sponsor-domænet (#2913/#2914/#2926) er BEVIDST udeladt — ejes af parallel ejer-session på [#2948](https://github.com/NicolaiDolmer/CyclingZone/issues/2948) (egen worktree; desuden deps-session aktiv i hoved-checkoutet på fix/react-router-v7-security). 25/7 aften: patch-notes-gap-audit lukket med 7.60 (3 huller fra ugen); Discord-roundups 20-25/7 postet af ejeren. Opfølgnings-issues: #2951 paginering-sweep · #2952 sticky-z-index; post-cutover-handlinger samlet i #2846-kommentar. **Bølge 1+2 afsluttet 25/7 (16 PR'er merged):** P0-bølgen (se 🩺 ovenfor) + bølge 2: #2896 terræn-nøgler (PR #2939, +CI-guard) · #2880/#2165/#2603 én z-index-skala (PR #2940) · #2883 planner-S2-banner + silent-fail-hardening (PR #2942) · #2889/#2915 hjælp: penge ved skiftet + bund 4 (PR #2941) · #2918 auktions-pensions-guard (PR #2947) + drejebogs-query rettet · audit-checket grønt igen (PR #2937 fjernede dødt endpoint). **Næste session: SØNDAGENS CUTOVER-VAGT** — drejebogen skridt 0-8; kræver ejer-go på endelig #2851-liste (~17:30) + #2700-varsel lørdag aften.
