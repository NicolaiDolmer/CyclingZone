...
> **🎯 Next action (16/7): TO merge-lister venter ejer.** Morgenbølge ([artifact](audits/night-wave-2026-07-16.md)): #2475-luk · #2474 · #2482+#2473 · #2483 · #2497 · #2481 (SQL→apply→trim) · #2472-beslutning (draft). **Dagbølge #2** ([artifact](audits/night-wave-2026-07-16-day2.md)): 9 PR'er — #2500 · #2501→#2506 (stacked; SQL) · #2502 · #2503 · #2504 · #2510 · #2507 (**bundle-budget-konflikt m. #2500 → sæt 816**) · #2505 (SQL) · patch-notes #2498 (v7.01+v7.02) **ALLERSIDST**. Done-flip pr. merge jf. runbook 5b.
