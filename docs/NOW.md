...
> **🎯 Next action (21/9 sen aften):** **Rækkefølge: MASTERPLAN øverst. Ejer 21/9: ingen udskydelses-kort, byg det lovede.** **A · ejerens hånd:** flip `training_score_visible` + udmelding · Android-test → flip `training_mobile_table` → slet gammel gren (#3643) · win-back #2760 inden 24/9. **B6 værdiskiftet #5443:** tørkørsel vist 21/9; patch note + hjælp = DRAFT #5461 (merges på kørselsdagen); mangler KUN ejeren: udmelding → flip v5 → "kør" (runbook; ikke søndag). **B7 S4-kalender #5405:** tørkørsel 21/9: bjerg 30,7 % mod 28 stopper `--apply`; ejer-valg "ret først" → PR #5460 (runde 2: fælles tilt + finale-bånd) → ny tørkørsel → `--apply`, go pr. kørsel. **Løfte-spor i bølge:** Graduation Day #2491 · skader i løbsdage #5462 · assistent-besked #4759. **Derefter:** flip-dag 28/9 (#5281, #4849) · /roadmap #5387 · #3813. **Codex (resten af 21/9):** prompt i `docs/drafts/codex-prompt-2026-09-21.md` (#5467 · #5435 · #3643).
