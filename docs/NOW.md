...
> **🟢 Seneste close-outs** (detaljer i git-historik + issue-tråde; ældre blokke trimmet jf. #1275): **14/6 (#1267):** board-mål launch-kalibreret + harness-realisme verificeret ([PR #1387](https://github.com/NicolaiDolmer/CyclingZone/pull/1387), ÅBEN). Issuets hypotese afkræftet empirisk: kalibrering flytter konsekvens-rate kun 50%→45,5%; ægte driver = results-kat. =0 ved 0 etapesejre (~½ af hold vinder 0; ægte motor 23-68% → ikke harness-artefakt). Option A (results-konkurrencedygtigheds-gulv) valgt+implementeret → rate 45,5%→18,2% (cal-seed), men ≤10% ikke robust af gulv alene (sæson-afhængig) → afventer leniency-valg (SCALE-knap). Findings: `docs/audits/2026-06-14-board-goal-calibration-findings.md`. **14/6 (tidl.):** multiagent-dagbølge — 9 issues/5 PRs merged (#1338/#1347-51/#1355/#1358) + #1357 season-notif (PR #1386) + #1342 CI-smoke LØST (PR #1385); patch notes 5.34/5.35. **13/6:** launch-blocker-audit (board 38→27).
