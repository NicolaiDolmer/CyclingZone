...
> **Session 11/7 (autonom aften, 2t+):** Lukket: #2266 (PR #2346, v6.89) · #2293 (PR #2347, v6.90) · #2284, #2245, #2265 (verificeret allerede shippet — PR #2246/#2275). Merged m. ejer-go: **PR #2345 (#2327 security: RPC-grant-revoke) + PR #2348 (#2326 lån-split, v6.91) — begge migrationer AFVENTER manuel apply** (+ tjek `2026-07-10-replace-race-selection-binding-guard.sql` fra #2275). Undersøgelser postet: #2254 (Clarity: landing-badge ligner knap m.fl.) · #2263 (ingen bred nulstilling; mangler rytter-ID fra ejer-DM).

> **🎯 Next action:** Ejer: (1) **apply 2 migrationer manuelt** (`2026-07-11-revoke-rpc-grants-2327.sql` + `2026-07-11-repay-loan-interest-split-2326.sql`; tjek også binding-guard-sql fra #2275), (2) verify-kø: /training (#1894+#1895), rytterprofil højde/vægt+⇄Sammenlign (v6.89), auktions-historik-sort (v6.90), lån-split efter apply, (3) eftersend rytter-ID til #2263. Derefter admin-test-køen eller #2270/#2274.
