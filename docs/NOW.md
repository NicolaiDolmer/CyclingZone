...
>
> **🎯 Next action (27/6 — 3 PRs MERGED):** #1926→[#1935](https://github.com/NicolaiDolmer/CyclingZone/pull/1935) (orphaned endpoints fjernet, audit-gate grøn) + #1916→[#1939](https://github.com/NicolaiDolmer/CyclingZone/pull/1939) (help-tal pinnet) = **done**. #1904→[#1940](https://github.com/NicolaiDolmer/CyclingZone/pull/1940) merged, men **holdes åben — din hånd mangler:** kør config-SQL'en (i [#1940](https://github.com/NicolaiDolmer/CyclingZone/pull/1940)-body: `update auction_timing_config set weekday/weekend_open=8, _close=24 where id=1`) + tilføj patch note → så går 08–24 live (0 aktive auktioner nu = sikkert) → luk #1904. **Plus din hånd:** holdudtagelse #1906/#1823/#1800 (real-konto-bekræftelse), CZ Pro [#1909](https://github.com/NicolaiDolmer/CyclingZone/pull/1909). **Næste kandidater:** [#1941](https://github.com/NicolaiDolmer/CyclingZone/issues/1941) (grace=0-beslutning), [#1922](https://github.com/NicolaiDolmer/CyclingZone/issues/1922) træningsfokus, [#1875](https://github.com/NicolaiDolmer/CyclingZone/issues/1875) Vercel preview-env, race-hub S2b (#1825/#1712).
>
