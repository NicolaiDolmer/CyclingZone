...
>
> **✅ [#2530](https://github.com/NicolaiDolmer/CyclingZone/issues/2530) (worker-subagent, worktree):** Scouting-facilitetssporet flippet live (`EFFECT_LIVE_BY_TRACK.scouting=true`) — Klub-UI viser nu tier-stige/køb/StaffPanel for scouting, ikke kun teaser. Motoren var allerede live (Talentspejder Fase 3 #2244); flippet gør den KØBBAR. Patch notes v7.06 (v7.05 taget af #2531 Discord-EN) + help.json (en/da) + backend-integrationstest af kæden facilitet-tier→hire→scoutAssignmentService. PR afventer ejer-merge.
>
> **✅ [#2521](https://github.com/NicolaiDolmer/CyclingZone/issues/2521) (agent-worktree, løsning A):** Sæson 1/baseline-bestyrelsen deltager nu i weekend-opdateringen (percentil blandt rigtige hold i puljen + økonomi), klampet 30-75; budget_modifier + hårde konsekvenser uændret (fortsat skippet for baseline). Patch notes v7.07. Dry-run-scorecard i PR-body (PR #2537).
