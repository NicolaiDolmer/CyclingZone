...
> **🎯 Next action:** (1) **EJER: merge [PR #2586](https://github.com/NicolaiDolmer/CyclingZone/pull/2586)** (#2578 trænings-kommunikation: loft-markering + "+N today"; design ejer-valgt 17/7) + verificér /training i prod bagefter. (2) **PR for #2580** (scouting-mission-regression) — subagent bygger; review når klar. (3) **Ejer-tests i prod:** Global Rank (noter i [#2453-kommentar](https://github.com/NicolaiDolmer/CyclingZone/issues/2453)) · bulk-priser /transfers · /planner fuld bredde · /training. (4) **S2-generering:** admin → Sæson → "Generér kalender" (dry-run-preview FØRST). (5) **#2568 del 2:** design-oplæg (flip-blocker peak_planner). (6) **#2557:** verificér variant C efter første nat-kørsel; #2574 share4+. (7) #2463 ejer-rest: `TEST_ACCOUNT_PASSWORD`. (8) Discord-announce 17/7-pakken + svar til @friisisch om #2578 (tekst kræver ejer-godkendelse; diagnose i issue-kommentar).
>
...
>
> **🤖 Working agent:** Fable-session 17/7: #2578 diagnosticeret (ingen motor-fejl — cap-omlægningens synlige bivirkninger; se issue-kommentar) + PR #2586 klar til ejer. Sonnet-subagent (worktree) arbejder på #2580. #2461 Discord-svar-udkast venter stadig ejer-review.
