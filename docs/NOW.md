...
> **🎯 Next action:** **Ejer-beslutninger 2/9 truffet (7 kort).** I gang i denne session: #4604 sprinter-anker (F3, #4246 = taktik-kortet vinder pr. etape) · #4603 dagsform (11 trin, kun eget hold) · #4602 Del D + Resend-nøgle · #4568 rebase · Pro/EUR #4074. Merget 2/9: #4593 U25=UCI (744 ryttere re-flagget), #4597 Pro-checkout åben, #4584, #4601 (kør `backend/scripts/dormantTeamsReport.js` før S4). **Derefter:** #4485-audit genkøres m. ny regel (samlet besked først) · Agony-kort: ejer spørger spillerne.
