...
> 1. **🔴 To design-specs afventer ejer-godkendelse (6/8-analysen kulminerede her):** [#3458](https://github.com/NicolaiDolmer/CyclingZone/issues/3458) ryttertype-fundament v2 (arketype-generation + percentil-skala; MÅLT: specialiserings-dybde median 0, kun 10,6-21 % har "rigtig" type — ejer valgte B + dybere fix) · [#3459](https://github.com/NicolaiDolmer/CyclingZone/issues/3459) løbsdags-modellen (løbet ER dagens arbejde; K4/K4′ AFVIST af ejer som overstyring/fup). Specs i docs/superpowers/specs/2026-08-06-*. **Spillerkommunikation #3372 PARKERET til fundament-fase 1 er live (ejer-beslutning).** #3441 fixet+shippet (v7.101); #3442 afkoblet; peak-talent BEVARET (måling på #3372: ingen mistede >5 point, store talenter urørte).
