...
> **PR #2205 (#1984/#2195 løbsdag-læsbarhed, Kørerprogram lag 1) afventer ejer-merge:** rod-årsag rettet (bræt/autofill/preview loadede binding uden game_day → CET-ordinal-falsk-positiv mod save-guardens game_day); "Race day N"-mærke + dag-gruppering + kompatibilitets-note + patch note v6.62. Lag 2 (formprojektion) + lag 3 (DS-rotationsindsigt) = følgeslices (spec i docs/superpowers/specs/2026-07-05-korerprogram-...). Verificeret på preview, ikke brugerrettet destruktivt.
