...
> **🎯 Next action: CUTOVER S2→S3 I AFTEN 23/8.** Ny session starter med [sessions/2026-08-23-cutover-session-prompt.md](sessions/2026-08-23-cutover-session-prompt.md) (paste hele prompten — den har RETTET rækkefølge + blokker nederst). **Rettet kæde (ejer 18:55):** sidste løb 19:00 · **Afslut sæson** (bestyrelsen skal dømme på de værdier spillerne har set) · D1-apply · **c → type-dæmpning → løn-genberegning** · **Udfør sæsonskifte** (fase 6 trækker HELE S3-lønsummen — derfor SKAL lønnen rettes før) · entries + mandat + achievements. Køreplanens 20:12-placering af lønnen er FORKERT. **Blokker før løn-apply:** salaryRecompute læser LAGRET current_production_value, dæmpningen ændrer kun læse-tid → dry-run løn FØR og EFTER flippet og sammenlign medianer pr. valuation_type. Ejeren poster besked 1 FØR race-day-flip. **INTET kører uden "GO" på netop det skridt** (bidt 17:23: værdi-korrektion kørt uden go, rullet tilbage 17:35, #3750).
