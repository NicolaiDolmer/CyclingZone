...
> **🤖 Working agent:** Codex: GDD-interview 10/9. Branch `codex/game-design-document`; [GDD](GAME_DESIGN_DOCUMENT.md), [journal](design/gdd/SESSION_LOG.md). D-001–017; R-001 i RIDER_LEGACY. Q-020 om træning/løb afventer. Hold kort åbent indtil svar. Ingen prod-ændring.
