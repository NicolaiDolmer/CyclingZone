...
> **🎯 Next action:** **DIN BESLUTNING på [#3503](https://github.com/NicolaiDolmer/CyclingZone/issues/3503)** — dry-run kørt 12/8 ([tal](https://github.com/NicolaiDolmer/CyclingZone/issues/3503#issuecomment-5255165861), script `potentialCapAlignmentDryRun.js`): 710 spiller-ejede bryder I1, **443 får højere stjerne**, base_value **+14,0 %** (+14,3 mio CZ$), og pot 5-6 går 11,0 %→**12,4 %** mod planens 1,4 %. Anbefaling: sæt tallet fra loftet **før** kvantil-remappen, så remappen retter fordelingen bagefter. → derefter **[#3582](https://github.com/NicolaiDolmer/CyclingZone/issues/3582)** før #3580/#3578 (21 auktions-kandidater, kun 1 kan bekræftes; **åben post: BPTrain mangler 40.000**) · #2650+#3461 · #3620 · #3585+#3600 før #2853.
