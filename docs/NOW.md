...
> **🤖 Working agent:** **A** (Fable, hoved-checkout): #4624 design-audit, ejer Playwright-slottet, rører kun `docs/audits/` + `docs/screenshots/`. **B** (bestyrelsen #4586 → #4579 → #4578, worktree `CyclingZone-worktrees/fix-4586-voice-name-salt`, kun board-specs) → S-M2c-spec.
