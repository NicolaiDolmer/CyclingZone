...
- 2026-05-04: **DD audit follow-up** — `auctions.is_flash` schema-divergens lukket: ny idempotent migration + kolonne tilføjet til schema.sql/supabase_setup.sql/setup.py + regression-test. Audit-rapport opdateret 22✅+1❌ → 23✅+0❌.
