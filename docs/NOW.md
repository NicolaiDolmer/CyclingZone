...
> **🎯 Next action:** (1) **#2080 kampagne-drafts før 4/7** (marketing; ejer-godkendt tekst). (2) **Ejer-clicks før TdF (~15 min):** **#2154** (opret #ops-webhook + sæt `DISCORD_OPS_WEBHOOK_URL`/`DISCORD_OPS_MENTION` i Railway — prod læser Railway-native env, ikke Infisical; aktiverer #2077 ops-kanal → sig til, så verificerer Claude end-to-end) + **#2076** (Sentry uptime-monitor + Discord-action på alarm-regel 559456). (3) **#2081-rest** (staged reveal · holdfilter · top-10) + luk #2072 efter GT-verify. (4) **Scouting-fane** (#2000-rest) + capstone/loft #2100. (5) #2082 trænings-scorecard (harness 5/7). (6) **#1972 backup-drop** ejer-gated. (7) **#1996** transfervindue-oprydning del 1 (PR #2151) — retter latent parkeret-for-evigt-bug; del 2 (`seasonTransition`/`squadEnforcement`) + Deadline Day EFTER TdF. **#1995** (etapeløb-udskudt-skifte) i gang oven på #1996 (`pending_team_id`, flush ved løbs-finalisering; slice-doc i docs/slices/). **Shipped+merged 3/7:** #2077 stall-watchdog + ops-routing + Sentry-heartbeat (PR #2148, `claude:done`; fallback-sikkert indtil ops-vars sættes). Railway-CLI logget ind → prod-logs læsbare (#2076-pkt 3 done). **Spøgelsesløb LØST 3/7 ([#2149](https://github.com/NicolaiDolmer/CyclingZone/issues/2149), PR #2155):** 192 tomme Division 4-løb (tier 4 managerløs; ikke 16 — verificeret) ryddet, div 1-7 urørt, forward-guard på plads. Åbent i #2149: scheduler-latency ~103t under catch-up. **Beslutnings-dag 6/7:** Alunta/CZ Pro + VMan + Discord-migration. Discord-posts kræver ALTID ejer-godkendt tekst.
