...
> **🎯 Next action (15/7 — [#2430](https://github.com/NicolaiDolmer/CyclingZone/issues/2430) rest):** Fix **stall-watchdog-alarmen**, ikke motoren. Triage 15/7 verificerede throughput **grøn**: 18:00-klyngen dræner 13,6 min (22/22 etaper), 0 hængende etaper i prod → #2396 virker, punkt (1)+(2) i #2430 kan lukkes. Tilbage: watchdog kalder etaper hængende der reelt kører få min efter plan (CYCLINGZONE-2G/-24). [Bevis](https://github.com/NicolaiDolmer/CyclingZone/issues/2430#issuecomment-4981085538). **Shipped 15/7:** #2435 merged+deployet (`dd34870f`) → CYCLINGZONE-31 verificeret tavs (0 hændelser/2 ticks, før ~12k/døgn), Sentry resolvet; 120t-backstop-margin noteret i #2434.
