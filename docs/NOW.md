...
_Opdateret af Claude (Claude Code) den 2. juni 2026 — #896 preview Kerne implementeret (PR #910): optjent-vs-udbetalbar + reconciliation + sanity-warnings. Epic #893 kerne-arbejde færdigt; rest = #896 #2/#5/#6 (udskudt) + #908 R2 v1.1._
