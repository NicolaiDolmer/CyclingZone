...
> **🎯 Next action (16/7): TO merge-lister venter ejer.** Morgenbølge ([artifact](audits/night-wave-2026-07-16.md)): #2475-luk · #2474 · #2482+#2473 · #2483 · #2497 · #2481 (SQL→apply→trim) · #2472-beslutning (draft, se taper-blok nedenfor). **Dagbølge #2** ([artifact](audits/night-wave-2026-07-16-day2.md)): 9 PR'er — #2500 · #2501→#2506 (stacked; SQL) · #2502 · #2503 · #2504 · #2510 · #2507 (**bundle-budget-konflikt m. #2500 → sæt 816**) · #2505 (SQL) · patch-notes #2498 (v7.01+v7.02) **ALLERSIDST**. Done-flip pr. merge jf. runbook 5b.

> **🎚️ [#2471](https://github.com/NicolaiDolmer/CyclingZone/issues/2471) — loft-semantik samlet. Draft-PR [#2472](https://github.com/NicolaiDolmer/CyclingZone/pull/2472): ejer valgte model A + alders-taper 16/7 — taper bygget + sim-gate genkørt (se PR-body for fuldt scorecard).** Møntkast-semantikken (kodesti-afhængigt `ability_caps`, kun skrevet når NULL) gav pot 4,5 loft 813 > pot 6's 737. Fix: ét loft `max(absolut(pot,anlæg), current)`, genberegnet hver tick — men det absolutte loft aftrappes nu efter peakAge (28) så veteran-aldringen (29-36) forbliver negativ. Afventer ejer-review af det opdaterede scorecard før merge (draft).
