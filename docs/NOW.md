...
## Senest leveret
- 2026-05-15: **`cross-pc-forensic-audit.ps1` hardlink-detektion fixet (`4067c92`).** `pwsh` 7 returnerer tom `LinkType` for hardlinks → audit flag'ede korrekt-linkede filer som orphan. Fix bruger `fsutil hardlink list` (samme pattern som `link-onedrive-context.ps1`). Postmortem: [`learnings/2026-05-15-cross-pc-audit-pwsh-hardlink-bug.md`](../.claude/learnings/2026-05-15-cross-pc-audit-pwsh-hardlink-bug.md).
