...
> **🎯 Next action (21/9 kl. 20):** **Ejer 21/9: ingen udskydelses-kort, byg det lovede.** **Merget 21/9:** #5169 · #5460 · #5466 · #5464 (Graduation Day) · #5463 (forum-links, patch note mangler). **Ejerens hånd:** værdi-udmelding i #the-roadbook → flip v5 → "kør" (runbook, ikke søndag; patch note = DRAFT #5461) · Android-test af mobil-træning · `training_score_visible` + udmelding · win-back #2760 inden 24/9. **S4-kalender #5405:** alt i mål på nær 5 finale-linjer; ejer-valg "ret først" → tørkørsel med 0 brud → `--apply`, go pr. kørsel. **#5465 skader i løbsdage:** grøn, men ejer-valg 21/9 = 5-25 løbsdage skal ind før merge. **Codex (prompt: `docs/drafts/codex-prompt-2026-09-21.md`):** #5468 bølge-indgang (review-punkter + PR-loft 8) · finale-typer · #5465-rettelse · #5435 · #3643 · samlet patch note. **Derefter:** flip-dag 28/9 (#5281, #4849) · /roadmap #5387.
