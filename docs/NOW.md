...
> **👤 Dine klik:** **[PR #3677](https://github.com/NicolaiDolmer/CyclingZone/pull/3677) FØRST** (bundle-budget 898→900 — main var selv over loftet, så perf-gaten er rød på ALLE frontend-PR'er indtil den er inde) → **[PR #3676](https://github.com/NicolaiDolmer/CyclingZone/pull/3676)** (scouting-chippen: "Høj tillid" → "Fuldt scoutet" + e2e-dækning af fanen — synlig UI, kræver dit blik) → derefter **[PR #3675](https://github.com/NicolaiDolmer/CyclingZone/pull/3675)** (e2e-mock var id-blind) · [#3486](https://github.com/NicolaiDolmer/CyclingZone/issues/3486) `VERCEL_TOKEN` (låser #1784) · #3393 kurve/eksponent/sats før merge · #3425 mobilbundbar A/B (venter siden 7/8) · **POST kommunikationspakken** (`docs/discord/2026-08-10-*.md`) + **[patch notes v7.112-7.117](discord/2026-08-12-patch-notes-catchup.md)** — klar, ikke postet.

> **📌 Opfølgninger:** **#3678** perf-gaten kører aldrig på main (ny 13/8) · #3620 kontraktår (regression af lukkede #2881, åben siden 24/7) · #3541 · #3669 (ny 13/8) · #3586 · #3172 CI-flake · #3640 · #3633. Gæld: **546 åbne, done-pukkel 23** (talt 13/8 — de gamle tal 524/19 var forkerte). 23 done-men-åbne kan lukkes; #3094 er duplikat af #2883.

> **🤖 Working agent:** Ingen aktiv session. Sidst: **transparens-sessionen 13/8** — auditten af alle 12 spillervendte flader der påstår noget om en rytters fremtid ligger i [`docs/audits/2026-08-13-transparens-flade-audit.md`](audits/2026-08-13-transparens-flade-audit.md) og er kravspec for #3666. Tre usandheder rettet + merged (#3672, v7.119); to PR'er venter (#3676, #3675). **Vigtigst derfra:** `faq.riderRating` ("the very best riders sit near 99") er sand i dag og falsk i det sekund den nye skala lander — den skal ligge i SAMME PR som #3666. **Målt, mod egne antagelser:** loft-båndets øverste kant ligger altid ≥ ½ halvbredde over sandheden (bevis i auditten), men per-manager-biasen ændrer kun dommen for 4,7 % af rytterne (300 ryttere × 120 simulerede managere) — G1 blev én linje tekst i stedet for en ombygning. Rod-årsagen bag hele auditten var **tre lag uden dækning**: ingen e2e-spec for Scouting-fanen, en id-blind scouting-mock og et id-blindt REST-filter der skjulte hinanden ([postmortem](../.claude/learnings/2026-08-13-tre-lag-uden-daekning-scoutingfanen.md)).
