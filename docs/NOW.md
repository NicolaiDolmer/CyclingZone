...
> - **⚠️ #1760 (op/nedrykning) = needs-fix, KRÆVER beslutning** (per-pulje-visning modsiger backend per-division-mekanik; design-fork bundet til [#1152](https://github.com/NicolaiDolmer/CyclingZone/issues/1152)) — merge IKKE som-is. Adversarisk review (2 bølger) hærdede #1746/#1666/#1755; resten ship-ready. Detaljer: [night-wave-artifact](audits/night-wave-2026-06-23.md).
