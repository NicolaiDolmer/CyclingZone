...
> **💰 Værdimodel v4 (#2428) — SLICE 1 SHADOW LEVERET 13/7** (PR [#2431](https://github.com/NicolaiDolmer/CyclingZone/pull/2431), ingen migration/økonomi-ændring, v3 uændret). Sim + fit + karriere-NPV (`predictBaseValueV4`) + scorecard + admin-preview (Admin→Økonomi). **Ejer-review før cutover:** [audit](audits/2026-07-13-valuation-v4-shadow-scorecard.md) — 6/7 gates grønne; runaway ~2,7-3,2× (verificeret: IKKE discount-tunbart — bind toppen el. hæv ×2-tærskel); β_pt degenereret (prize=75×point); elite-halen er free agents (ekstrapolerer, inkludér i sim); type-økonomi inverterer v3; R²=0,36. **Cutover (slice 2) = separat ejer-gated session:** afgør elite-hale + top-binding + Q1-Q3 → re-fit til alle gates grønne. Rør ALDRIG GENERATED-kolonner/prize_earnings_bonus før da.
