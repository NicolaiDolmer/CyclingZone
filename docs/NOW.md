...
> **🎯 Next action (session 17/7, ejer-aftalt):** (1) Discord-announce (godkendt udkast) — SPØRG; læg scout-køb-announce oveni (#2357+#2530, drafts findes). (2) **Markedsføring** (AI_CHANNEL_ROUTING + #1341). (3) Verificér AI-trim 24/24/24 + #2472-normalisering efter næste trænings-tick. (4) **#2463 ejer-rest (MIND EJEREN OM DEN):** klik board-kæden som test-a ELLER læg `TEST_ACCOUNT_PASSWORD` i `backend/.env` (TESTING.md). (5) Verify: ejer ser /planner-cockpit m. ny dato-UX (#2517+#2533 live) → flip `peak_planner_enabled` on ("senere", ejer 16/7) · /klub scout-køb klik-verify · Sentry CYCLINGZONE-33/34 stoppet (34-fix #2538) · første `boardT1Reminder`. (6) PR [#2537](https://github.com/NicolaiDolmer/CyclingZone/pull/2537) board-tilfredshed (ejer valgte A; scorecard i PR) → merge; #2458 ejer-go (mission 14→6 foreslået). Derefter: #2361 → #2449 (+#2518 S2-planner) → [#2512](https://github.com/NicolaiDolmer/CyclingZone/issues/2512).
>
...
>
> **🌙 Session 16/7 sen aften (Fable-arkitekt + 4 sonnet-workers i worktrees):** Discord-sweep 16/7 → 13 issues [#2518](https://github.com/NicolaiDolmer/CyclingZone/issues/2518)-[#2530](https://github.com/NicolaiDolmer/CyclingZone/issues/2530) + analyser: #2528 oprykning (**ejer: status quo S1→S2**, ekstraordinær oprykning vurderes i S2), #2458 spejder-varigheder (forslag 14→6 dage, ejer-go mangler; ⚠️ 35 aktive missioner modner EFTER sæsonskiftet — #2361 må ikke annullere dem), #2521 "fast på 50" = 3 kilder (baseline/pending-forhandling/aggregat ≈50 — ejerens egen board bevæger sig: 47/52/52). **MERGED+LIVE:** #2531 Discord-EN (v7.05) · #2532 scout-køb åbnet (v7.06) · #2533 planner-dato-UX (beta-gated) · #2534 CI-guard-fix · #2538 stall-watchdog-fantomkolonne (#2536, Sentry-34; ANDET call-site end #2516). Åben: PR #2537 baseline-tilfredshed (ejer-valg A; rebase→v7.07). Railway-MCP kræver `railway login` igen.
