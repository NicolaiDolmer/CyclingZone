...
> **🎯 Next action (15/7 — ejer-merge):** **PR [#2435](https://github.com/NicolaiDolmer/CyclingZone/pull/2435)** (#2434, grøn, ingen SQL) fjerner CYCLINGZONE-31-falsk-positiven = **~12k Sentry-hændelser/dag** (Sentry ignoreret til 18/7 som midlertidig bremse). Derefter **[#2430](https://github.com/NicolaiDolmer/CyclingZone/issues/2430)**: triage 15/7 verificerede throughput **grøn** — 18:00-klyngen dræner 13,6 min (22/22 etaper), 0 hængende etaper → #2396 virker. Rest = fix **alarmen** (watchdog kalder etaper hængende der kører få min efter plan), ikke motoren. [Bevis](https://github.com/NicolaiDolmer/CyclingZone/issues/2430#issuecomment-4981085538).
