...
> **🩹 Åbne fra 30/8:** **#4423** akademikontrakt midt i løb (PR #4422 = del A, DU merger) · **#4356** de 34 allerede kørte etaper: re-sim eller stå ved dem · **#4357** `loadEntrantsForRace` mangler ORDER BY (bevidst urørt til #4356 er afgjort) · **#4103** falsk done-flag - målt 31/8: højbjerg brudt i **3 af 4** divisioner (tal i tråden) · **#4370** React #421 på forsiden · **#4146** 24 hold over trupgrænse · **#4204/#4507** verify-invariants timer ud mod prod, nu **blokerende** for kalender-vagten.
