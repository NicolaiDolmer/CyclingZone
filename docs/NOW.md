...
> **🤖 Working agent:** Ingen aktiv session. GDD overdraget til Claude efter Q-031/D-028; branch `codex/game-design-document`. Ingen prod-ændring.
