...
> **🎯 Next action:** **Opsamlingssession** — prompt: `docs/drafts/session-prompt-2026-09-16-opsamling.md` (detaljer dér). Tre uafklarede: loft-designet (🟡) · sponsor #4860/#5263, **deadline 27/9** · apply-go-kort #5268 + #4619. **Merget 16/9:** 5 PR'er (senest #5301) — køen er TOM. **Codex 17/9:** `docs/drafts/codex-prompts-2026-09-17.md` (4 prompter, ét spor ad gangen, merger ALDRIG). **Parkeret af ejer 16/9:** #5281 (vent på B4) · #5267 løbsdage (1-2 sessioner) → dermed #5169 + B4 #5264s grid; #5264 er CONFLICTING. **Øvrigt:** #5263 · #5235 · #5262 · #3512.
