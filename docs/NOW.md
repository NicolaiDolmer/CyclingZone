...
> **🎯 Next action:** **[#3582](https://github.com/NicolaiDolmer/CyclingZone/issues/3582)** (ny session, ejer 12/8) — revisionsspor for rytter-ejerskab. **[#3503](https://github.com/NicolaiDolmer/CyclingZone/issues/3503) er IKKE en åben beslutning:** "A nu, B senere" blev låst 7/8 (issue-tekst + spec §6 trin 1) — lofterne regnes ud fra de NYE 1-99-potentialer, ikke omvendt; A = rolle-faktorer der skaleres med potentialet (= beslutning 3's 8 type-loftprofiler). Dry-run'en (`potentialCapAlignmentDryRun.js`) hører hjemme i **trin 1's egen diff**: gulvet `max(tapered,current)` overlever migrationen, og 1.747 ryttere (710 spiller-ejede) ligger over deres loft med snit 9,5 point. Derefter **[#3582](https://github.com/NicolaiDolmer/CyclingZone/issues/3582)** før #3580/#3578 (21 auktions-kandidater, kun 1 kan bekræftes; **åben post: BPTrain mangler 40.000**) · #2650+#3461 · #3620 · #3585+#3600 før #2853.
