...
> ⚠ **To huller står åbne, begge ejer-gatede.** (1) **Uheld og tidsgrænse rører ikke en TTT.** M10 og M15 bor i segment-loopet, som TTT-grenen ikke går igennem. Tidsgrænsen kan ikke bare anvendes uændret: en TTT-ankomstgruppe *er* et helt hold, og grupetto-redningen er kalibreret til et massestartsfelt, så et enkelt langsomt hold ville ryge ud af løbet samlet. (2) **Massestarts-ankrene måler skævt på TTT.** `same_team_top10_share_4plus` (bånd < 3 %) er strukturelt 100 % på en holdtidskørsel — det vindende holds ryttere *deler* tiden og fylder derfor top 8 med rette. Ankret bør sandsynligvis udelade tidskørsler, men det er en ændring af en ejer-godkendt målestok (§4 *"Et gulv er ikke et mål"*) og ikke noget denne wiring gør på egen hånd.
