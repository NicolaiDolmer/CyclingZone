...
>
> ⚠ **Stadig ejer-valg:** TTT i S4-kalenderen (`calendarCompositionTargets.js`'s `TTT_ENGINE_SUPPORTED`, filleren i `raceStageProfileGenerator.js`), v3's manglende bonusloft (kun relevant hvis flippet glider) og passage-rækken for en rytter der vinder en indlagt spurt og senere udgår (§2g).
