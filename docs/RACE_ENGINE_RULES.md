...
| 9 | `positioning` og `tactics` står i `AbilityKey` og vægter i finalens demand-vektorer, men **ingen rytter i spillet har dem** (0 af **5.955** i den pinnede population — `backend/scripts/baselines/population-snapshot-2026-09-07.json`, re-eksporteret + verificeret 7/9 efter #4936 (juli-snapshottet, 5.650 ryttere, var skævt/forældet); **rettet fra 5.938**, som var et forældet, usporet tal og selv var uenigt med audittens egen "5.650"-linje samme sted). Vægten falder tavst på gulvet, så bl.a. massespurt-finalen afgøres på en mindre del af sin egen vektor end tabellen antyder | [#4604](https://github.com/NicolaiDolmer/CyclingZone/issues/4604) · [#4936](https://github.com/NicolaiDolmer/CyclingZone/issues/4936) |
