...
**Algoritme:** tiers 1,0-4,0 beholder deres tier-centre (form-bevarende intra-tier-spredning ±4,9 via rang — 1-99-granularitet uden tier-skift); kun ≥4,5-klassen (961 ryttere, "pot 5-6"-overskuddet fra spec §3) kvantil-presses mod planens HALE-ankre pr. aldersbånd: antal ≥74,5 ("5,0+") / ≥84,3 ("5,5+") / ≥94,1 ("6,0") = planens masser (0,70 % / 0,32 % / 0,11 % af båndet). **Fredningsgulv (ejer-justering 9/8 aften efter første diff): en gammel 6,0'er lander ALDRIG under 80** ("5,0-ækvivalent", loft ~80) — blob-placerede 6,0'ere løftes rang-sikkert ind i [80, 84,3). Rang bevares fuldt (0 brud verificeret, inkl. efter løftet). Ned/op-klassifikation: tier-ækvivalent-skift >0,28 (kvart trin + afrundingskorn; intra-tier-spredning tæller ikke).

**Resultat (samme daterede snapshot, med fredningsgulv):**
...
- **Landing for de 961:** 863 → "4,5-ækvivalent" (65-74) · 72 → 74,5-84,3 (heraf ALLE gamle 6,0'ere ≥80) · 17 → "5,5"-segmentet · 9 → "6,0" (94,1-99). Hårdeste enkelt-nerf er nu gamle 5,5'ere → ~70 (−0,98 tier; loft ~73); gamle 6,0'ere bunder på 80 (−~0,97 tier; loft ~80).
- **Hale-gate:** ≥84,3 og ≥94,1 matcher planen i alle bånd (26 hhv. 9); **≥74,5 = 98 mod plan 57 — accepteret overskridelse = fredningsklassen** (stock-legacy, eroderer ved aldring; alle FREMTIDIGE træk følger geometrien). Stock-gate: 16 ≥90 mod forventet 16,4 (0,20 %).
- **Værdi-effekt (v4, offline):** 607,1 → 562,2 mio. = **−45,0 mio. (−7,4 %)** mod A's −27,0 %. Største enkelt-tab: Carlos Lozano (fri agent, kendt 22/6-legacy) −3,2 mio.; største human-ejede: Thomas Ward (6,0 → 82) −1,3 mio.
- **Manager-diff:** 289 human-ejede nedjusterede fordelt på 110 af 192 human-hold; hårdest ramte hold mister 9 ryttere i tier-status (mod 37 i A). Top-5: Top Pro Cycling/rivka583 (9 ned, −0,8 mio.) · LEGO-Vestas/dolamba (9, −1,1 mio.) · FOSS-Trackman/andrecl1 (8, −0,6 mio.) · Team Hansen/CyberSimon (7, −1,2 mio.) · Équipe Lorraine Acier/Friisørens Salon (6, −0,2 mio.). Fuld tabel: `remap-dryrun-result-b.json` → `manager_diff`.
- **Åbent delspørgsmål (stillet ejeren 9/8 aften):** gamle 5,5'ere har nu det hårdeste fald (→ ~70) og der opstår et hul 75-79 mellem dem og de fredede 6,0'ere. Skal 5,5 have et analogt gulv (fx 74,5), eller står fredningen kun for 6,0? NB: hvert ekstra gulv udvander udligningen (5,5-gulv ville lægge +176 i 74,5+-halen → 274 mod plan 57).
- **Gate-konsekvens:** fuld-form-gaten T1-N3 (±2pp mod plan-CDF) gælder KUN variant A; for variant B er migrations-målet hale-ankrene (`tail_gate`) + form-bevarelse i tiers ≤4,0 + dokumenteret frednings-undtagelse på ≥74,5. Gate-biblioteket skal have denne variant-B-målsætning med før PR-2.
