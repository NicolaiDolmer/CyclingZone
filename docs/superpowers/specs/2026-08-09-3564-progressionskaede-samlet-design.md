...
- [x] **A. Remap-afgrænsning (ejer 9/8 aften): variant B — hale-korrigeret remap.** Tiers 1,0-4,0 form-bevares (intra-tier-spredning); kun ≥4,5-klassen (961) presses mod planens hale-ankre (≥74,5/≥84,3/≥94,1 = 0,70/0,32/0,11 % pr. aldersbånd). Dry-run B: 470 nedjusterede (kun pot 5,0-6,0), −8,0 % værdi (mod A's 7.243/−27 %), 0 rang-brud, hale + stock-gate rammer plan. Diff forelagt ejeren visuelt 9/8 aften; fuld rapport i [trin1-remap-dryrun](2026-08-09-3564-trin1-remap-dryrun.md). Migrations-målet for PR-2 = variant B; T1-N3 omdefineres til hale-ankre + form-bevarelse for denne variant.
