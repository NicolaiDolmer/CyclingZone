...
| 9 | ~~§6's `seededUnitMixed()`-krav gælder også pensionsrullet, men pensionsvarslet (#2700/#2748) beregnes on-the-fly ved hver visning og har ingen frysning.~~ **LØST** — ejer-beslutning 10/9 kl. 16:05 i [#5073](https://github.com/NicolaiDolmer/CyclingZone/issues/5073) (ordret: "A: genopret loeftet + gem varslet"). Varslet er nu en gemt kendsgerning på `riders` (§6, sidste række): rullet bruges kun til at afgøre svaret første gang, og både rytterkortet, cutover og sæsonstartens indbakkebesked (#2748) læser derefter kolonnen. Kun SSOT — GDD'ens beslutningslog (D-001–D-048) er uændret, fordi designet (pension mellem 36 og 40, varslet ved sæsonstart) aldrig blev ændret; det var implementeringen der lod svaret rulle om. Målingen bag: 58 af 229 ryttere i vinduet (36-39) skiftede svar da #4987/#4990 blev merged 7/9 (36 fik, 22 mistede; 38 af dem på menneskehold). **Mekanikken er merged, men reparationen er en ejer-gated ops-kørsel** (`OWNER_GO=1 … --execute`): indtil den er kørt, fryser hver visning af et rytterkort det NUVÆRENDE svar. Kørslen overskriver derfor bevidst markører for den aktive sæson (de kan kun stamme fra lazy freeze efter dette deploy) og rapporterer hvor mange der nåede at blive frosset først | [#5073](https://github.com/NicolaiDolmer/CyclingZone/issues/5073), `backend/lib/retirementNotice.js`, `scripts/ops/retirement-notice-freeze-5073.mjs` |
