...
## Aabningsbeslutning: trin 7 visuelt go

Ejeren sagde 18/8 aften "ikke helt klar endnu, men vi kan tale om tingene i denne session". Saa sessionen AABNER med trin 7-gennemgangen: vis de 5 flader igen (pr-screens/3746-*.png), gennemgaa hvad spillerne kommer til at se aendre sig (lofter loeftes, "faerdig"-markering bliver sjaelden, prognose-baand), og faa ejerens go eller hans aendringsoensker. Alt i Blok 2 afhaenger af raekkefoelgen: trin 7-merge FOERST, derefter strukturbygget, saa traeningsfladen kun ombygges een gang.
...
1. **Strukturen foerst (#3721) - PLANEN FINDES ALLEREDE og er ejer-gennemgaaet:** `docs/design/3721-traeningssidens-struktur/mockup.html` (14-16/8) er plan-of-record: roster som rygrad (114 px over rosteret i stedet for 637), filterbjaelke, kolonner 10 -> 6, rapport-tabellen -> Today-kolonne, mobil-raekkeliste under 640 px, og **faner 9 -> 7** (Overblik · Traening · Udvikling · Scouting · Fysiologi · Resultater · Marked; Resultater+Palmares slaas sammen, Historik+Interesse -> Marked; Traening og Udvikling holdes bevidst adskilt). Fokus-panelet er allerede merget (#3764). Strukturbygget var gated af #3762 (dagstype-aksen) - trin 1 er live 15/8, saa PR 1 (struktur) kan bygges NU paa den nye akse. Design IKKE forfra; byg planen. **Det sidste design-spoergsmaal blev AFGJORT 18/8 aften (ejer-valg B): /training faar faner - Squad / Yesterday's gains / History.** Squad = roster-rygraden med Today-kolonnen; Yesterday's gains = hele #3924-kvitteringen; History = 30 dage; summeringslinjen staar i sidehovedets undertitel. Detaljer i kommentarer paa #3721 og #3924. PAGE_TEMPLATES er bindende (fane-moensteret paa en T2-side er en bevidst udvidelse, dokumentér den).
