...
1. ERSTATTET 22/9 (Claude-bølge, ejerens rækkefølge): ryttertyper #5327 → ratings #5435 (1d, model A, bag kontakt) → værdier #5497 (typefri + marked; Codex' 1b er diagnostik). 1c admin-forhåndsvisning og #5461 kørselsdag lander efter ejerens "godkendt til build" (R6 i #5497). Codex rører IKKE #5327/#5435/#5443/#5497.
