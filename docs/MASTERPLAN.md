...
Sentry-fejl, løb der sidder fast, alle spillervendte bugs — hver uge uanset alt andet. **LEVERET 19/7 (6 PR'er merged + 2 migrationer applied+verificeret):** #2676 anon-rollover-security · #2692 rider-ranking-perf (dediker RPC) · #2694 holdklassement ≥3 finishers · #2526 etapelinks · #2581 spejder-fantom (AI-ejede) · #2647 invariant-vagt. _(#2692-migration: post-apply-verifikationen fangede + lukkede en anon-EXECUTE-eksponering Supabase auto-grantede — advisor 0028 nu ren.)_ **Åbne (ejer/balance):** #2699 akademi-overflow (forslag+sim-scorecard klar → ejer-beslutninger; auktions-ryttere fredet pr. ejer 19/7) · #2589 sponsor-rate (strategi-valg) · #2263 rytter-stats (ejer-blokeret: screenshots). GT ITT-dominans: #2404 (+#2402/#2403/#2405/#2406). Triage-rest: #2260/#2257/#2261/#2254/#2259. **Sentry 19/7:** roligt — alt kritisk resolved; kun #2692/CYCLINGZONE-36 fyrer stadig (lav severity, archived).
