...
**Balance er rød:** #2731 maxRiderWinRate 0,67-0,75 vs mål 0,45 (siden 16/7) · #2557 hold-dominans — nu også spiller-fortælling ("Wander Riders tager os alle") · balance-drift-vagten meldte bånd-brud 30/7 + 2/8 + 3/8 · #3015 AI-ryttere restituerer aldrig · #3009 scorecards exiter grønt trods FAIL. **Dataintegritet:** #3185 dobbeltbooking-vagten VOKSER dagligt (4→7 par på 4 dage, Sentry CYCLINGZONE-44 escalating) — formodet rodårsag #3119.
