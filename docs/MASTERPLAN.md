...
6. 🟠 **Verdensklasse bølge 1 (ejer-godkendt 5/8):** epic [#3395](https://github.com/NicolaiDolmer/CyclingZone/issues/3395) → #3396-#3402 (Final Km · moment-kort · Maiden Win · narrative notifikationer · Discord-resultat-DM · auktions-reveal · sæsondokumentar TIL 23/8). Plan: `docs/superpowers/specs/2026-08-05-verdensklasse-game-plan.md`. Natbølge-kandidat; UI-issues kræver mockup-go.

## 2 · EJER-DIREKTIV-SPORET (nyt 31/7-3/8 — rækkefølge kræver ejer-ja)
Fra #feedback-from-dolmer: ✅ **#3196** vækst-dashboard LUKKET 3/8 nat (/admin/growth, 110 dages backfill; RPC-lås unødvendig — advisor-fund er kendt falsk positiv) · ✅ **#3197** resultat-fladen LUKKET 3/8 nat (vælgere + egen kontekst + ægte datoer) · ✅ **#3198** økonomi-audit LUKKET 3/8 nat (13 fund; kritisk forecast-hul → **#3236, priority:high, ejer: fix inden få dage**) · **#3199/#3200** in-game forum m. polls + spiller-beskeder (design-samtale først) · **#3201** admin-notifikation ved spillerbeskeder (+#2739 ping-fixet) · ✅ **#2792+#3193** lukket 3/8 (PR #3217) · **#2758** daglig Discord→GitHub-automation (design klar på issuet, afventer go).
