...
- **GJORT MAN 24/8:** hele kalender/binding-kæden + #4183-swap + PR #4182 — detaljer i NOW/issue-tråde. **REST:** **#4159 guard-rest** = kun DB-trigger-laget tilbage (relationel, ikke dato-formel) · #4162/#4164 hjælpetekster · kalibrering → **ejer-gate på v4-flip** · #3720 · /pro S3-launch · velkomstpost.
