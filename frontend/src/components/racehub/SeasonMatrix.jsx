    ...
    <div className="mt-5">
      ...
      <div className="rounded-cz border border-cz-border bg-cz-card overflow-x-auto">
        ...
        >
          ...
          <thead>
            <tr>
              <th rowSpan={raceLanes.laneCount + 2} className="sticky left-0 z-table-corner bg-cz-subtle border-b border-r border-cz-border cz-pinned-rule-end px-3 py-1.5 text-left align-bottom" style={{ minWidth: 148 }}>
              ...
              .map((rider) => {
                ...
                return (
                  <tr key={rider.id} className="group">
                    <td className="sticky left-0 z-table-col bg-cz-card group-hover:bg-cz-subtle border-r border-b border-cz-border cz-pinned-rule-end px-3 py-1 text-left">
