...
export default function AcademyPnl() {
  ...
  if (loading) {
    return (
      <section>
        <h2 className="font-data text-2xs font-semibold uppercase tracking-[.1em] text-cz-3 mb-3">{t("pnl.heading")}</h2>
  ...
  return (
    <section>
      <h2 className="font-data text-2xs font-semibold uppercase tracking-[.1em] text-cz-3 mb-1">{t("pnl.heading")}</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="bg-cz-card border border-cz-border rounded-cz p-4">
          ...
          <p className="text-2xs text-cz-3 mt-3">{t("pnl.premiumCaption")}</p>
        </div>
        ...
        <div className="bg-cz-card border border-cz-border rounded-cz p-4">
          ...
          <p className="text-2xs text-cz-3 mt-3">{t("pnl.currentCaption")}</p>
        </div>
      </div>
