  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // #5242: dækker også limited (429-vindue), unauthorized og networkError
        // (status 0) — alle tre ender i den eksisterende ErrorState nedenfor,
        // præcis som den kastede fetch-fejl gjorde før.
