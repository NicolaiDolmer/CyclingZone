...
export default function ProBadge({ isFounder }) {
  return (
    <span className="inline-flex items-center gap-1 border border-cz-accent rounded-cz px-1.5 py-0.5 text-3xs font-bold uppercase tracking-wider text-cz-accent-t">
