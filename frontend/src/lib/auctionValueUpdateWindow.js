...
// afsluttes EFTER søndagens værdi-genberegning (backend/lib/trainingSweep.js
// → refreshChangedRiderValues, kun søndag >= kl. 22 dansk tid, kørt via
// cron.js's 5-min-poll — se copenhagenHour/copenhagenWeekdayKey i backend/lib/
...
export const VALUE_UPDATE_HOUR = 22;
 ...
 * (server-cronen poller hvert 5. minut, så reel kørsel kan ligge op til ~5
 * min senere — irrelevant for et bud-flow-varsel, som kun behøver "før eller
...
export function nextSundayValueUpdateUTC(now = new Date()) {
  ...
  // I dag ER søndag OG klokken er allerede forbi 22:00 dansk tid — den næste
