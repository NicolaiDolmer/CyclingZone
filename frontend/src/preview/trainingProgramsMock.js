...
export const PREVIEW_TRAINING_PROGRAMS = [
  ...
  {"key":"classics","name":{"en":"Classics rider","da":"Klassikerrytter"},"tagline":{"en":"Cobbles, crosswinds and punch for the one-day races in spring.","da":"Brosten, sidevind og punch til forårets endagsløb."},"targetTypes":["brosten","puncheur"],"audience":null,"days":{"mon":"cobbled_sectors","tue":"endurance","wed":"echelon_drills","thu":"recovery","fri":"vo2max_punch","sat":"tempo","sun":"rest"}},
