  ...
  return (
    <div className="min-h-screen bg-cz-body py-10 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        {/* #2849 bølge 6: DA-tvillingens struktur (PrivacyPolicyPage.jsx) —
            ui/Section (kanonisk kort) + ui/SectionHeader i stedet for den
            lokale Section-komponent med sin egen h2-opskrift. Hold disse to
            filer strukturelt identiske ved fremtidige ændringer. */}
        ...
        <SectionStack>
          <Section>
            <SectionHeader title="Who is the data controller?" />
          ...
          <Section>
            <SectionHeader title="What data do we process?" />
            <div className="text-cz-2 text-sm leading-relaxed">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li><strong>Aggregate traffic statistics (no consent needed):</strong> we count anonymous, aggregated page views and engagement (e.g. how many visitors a page received and whether they engaged) without cookies and without storing IP addresses or any data that can identify you. We also record which page a visit came from and any campaign tags in the URL, so we can see which channels bring visitors. That is information about the referring link, not about you. Because it cannot be linked to you, this requires no consent.</li>
          ...
          <Section>
            <SectionHeader title="Founder waitlist (non-binding expression of interest)" />
            <div className="text-cz-2 text-sm leading-relaxed">
              <p className="mb-2">
          ...
          <Section>
            <SectionHeader title="Third parties (data processors)" />
            <div className="text-cz-2 text-sm leading-relaxed">
              <ul className="list-disc pl-5 space-y-1">
          ...
          <Section>
            <SectionHeader title="How long do we keep data?" />
            <div className="text-cz-2 text-sm leading-relaxed">
              <ul className="list-disc pl-5 space-y-1">
          ...
          <Section>
            <SectionHeader title="Your GDPR rights" />
            <div className="text-cz-2 text-sm leading-relaxed">
          ...
          <Section>
            <SectionHeader title="Your current choices" />
