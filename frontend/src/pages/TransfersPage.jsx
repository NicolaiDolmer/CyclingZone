...
const VALID_TABS = ["received", "sent", "archive", "loans", "market"];
...
const TAB_MODES = [
  ...
  { key: "negotiations", tabs: ["sent", "archive", "loans"] },
...
export default function TransfersPage() {
  ...
  async function loadAll() {
    ...
    try {
      ...
      const [listingsRes, offersRes, swapsRes, loansRes] = await Promise.all([
