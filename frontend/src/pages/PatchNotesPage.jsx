    ...
    changes: [
      {
        ...
        items: [
          "EN · Published the Race Engine Architecture V1 decision record: Cycling Zone will use physiology-first rider profiles, stage demand vectors, seeded simulation, and derived traditional abilities as the foundation for the TdF race-engine build. Refs #675.",
          "DA · Race Engine Architecture V1-beslutningen er publiceret: Cycling Zone bygger videre på fysiologiske rytterprofiler, etape-demand vectors, seeded simulation og afledte traditionelle abilities som fundament for TdF-race-enginen. Refs #675.",
        ],
      },
    ],
  },
    ...
    changes: [
      {
        ...
        items: [
          "EN · Cycling Zone has been free since the start, and the competitive game will stay free. I am now asking players whether there is a fair way to make the project sustainable long-term.",
          ...
          "DA · Cycling Zone har været gratis siden starten, og det konkurrencemæssige spil forbliver gratis. Jeg spørger nu spillerne, om der findes en fair måde at gøre projektet bæredygtigt på lang sigt.",
