...
test.describe("Auction custom end time (#2884)", () => {
  test.beforeEach(async ({ page }) => {
    ...
    // #5102/D-047 + ejer-beslutning 10/9: Mit holds tre standardkolonner paa
    // mobil er OVR, vaerdi og loen, saa handlingskolonnen er eet chip-tryk vaek.
    // Paa desktop er kaldet en no-op (alle kolonner staar allerede fremme).
