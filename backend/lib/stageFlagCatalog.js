...
export const STAGE_FLAGS = Object.freeze([
  ...
  { key: "academy_intake_pull_enabled", area: "academy", label: "Akademi — traek af nye talenter" },
  { key: "intake_offer_expiry_enabled", area: "academy", label: "Akademi — udloeb paa tilbud" },
  { key: "season_academy_intake_enabled", area: "academy", label: "Akademi — saesonoptag" },
  { key: "board_mandate_model_enabled", area: "board", label: "Bestyrelse — mandat-modellen" },
  { key: "daily_training_enabled", area: "training", label: "Daglig traening" },
  { key: "training_score_visible", area: "training", label: "Traeningsscore 1-99 (visning)" },
  ...
  { key: "race_day_development_enabled", area: "race-day", label: "Udvikling paa loebsdage" },

  // ── Motorer og batch-jobs (spilleren ser resultatet, ikke kontakten) ──────
  { key: "race_engine_v2_enabled", area: "race-engine", label: "Loebsmotor v2" },
  { key: "race_engine_v3_scoring", area: "race-engine", label: "Loebsmotor v3 — scoring" },
  { key: "race_engine_v4", area: "race-engine", label: "Loebsmotor v4" },
  { key: "race_day_engine_enabled", area: "race-engine", label: "Loebsdags-motor" },
  { key: "race_finalize_resumable_enabled", area: "race-engine", label: "Genoptagelig finalisering" },
  { key: "stage_scheduler_enabled", area: "race-engine", label: "Etape-skemalaegger" },
  ...
  { key: "auto_prize_enabled", area: "economy", label: "Auto-praemier" },
  { key: "season_end_pool_reseed", area: "season", label: "Saesonslut — genfyld rytterpulje" },
  { key: "season_end_skip_division_movement", area: "season", label: "Saesonslut — spring op/nedrykning over" },
  { key: "season_fatigue_reset_enabled", area: "season", label: "Saesonslut — nulstil traethed" },
  { key: "season_documentary_llm_enabled", area: "season", label: "Saeson-dokumentar (LLM)" },
  ...
  { key: "market_value_sweep_enabled", area: "market", label: "Markedsvaerdi-sweep" },
  { key: "rider_values_bulk_write_enabled", area: "market", label: "Rytterevaerdier — bulk-skrivning" },
