...
//
// Navne følger et cykelhold-mønster (sponsor + suffix) uden noget AI-præfiks (#1775
// — "AI 1"-stil navne brød indlevelsen, AI-badget i UI'en er allerede den skelnelige
// markør). Identifikation af AI-hold sker udelukkende via `is_ai`-flaget, aldrig via
// navnet. Determinisme: navn vælges af et per-hold seed (basis XOR hash(pulje:indeks)),
// så en replay giver identiske navne. Ved kollision (samme pulje-seed-rum eller
// eksisterende navn) tilføjes et numerisk suffix.
