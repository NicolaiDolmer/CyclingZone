...
//     --model=lib/riderValuationModelV5.json --out=<mappe>
...
const MODEL_PATH = resolve(join(BACKEND, String(arg("model", "lib/riderValuationModelV5.json"))));
const ROLE_WEIGHTS = "display_recipes";
