...
//
// Valgfrit:
//   --model=<sti>   kandidat-model (default lib/riderValuationModelV5.json)
...
const CANDIDATE_PATH = resolve(arg("model", join(LIB, "riderValuationModelV5.json")));
...
const NAMED = []; // Supply private examples outside version control.
