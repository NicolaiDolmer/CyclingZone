...
30. **Områdets SSOT læses, citeres og opdateres i samme PR** (ejer-mandat 25/8, [#4221](https://github.com/NicolaiDolmer/CyclingZone/issues/4221)). Rører opgaven et område med et SSOT-dokument, gælder fire ting: **(a)** dokumentet læses FØR der røres kode, data, prod eller design; **(b)** ethvert nyt design-dokument citerer sit områdes SSOT eksplicit — et design uden citat er ikke godkendt til build; **(c)** ændrer arbejdet en regel, en konstant eller en kontrakt, opdateres SSOT'en i SAMME PR som ændringen; **(d) et nyt område eller en ny kernefunktion fødes med sit SSOT-dokument** — dokumentet er en betingelse for at feature'en må lukkes, ikke et efterslæb (ejer-direktiv 25/8, [#4266](https://github.com/NicolaiDolmer/CyclingZone/issues/4266)). En regel der kun står i en spec er en parallel plan.
    **Områder og deres SSOT:** kalender → [`docs/CALENDAR_RULES.md`](docs/CALENDAR_RULES.md) · race-motor, ruter og taktik → [`docs/RACE_ENGINE_RULES.md`](docs/RACE_ENGINE_RULES.md) · holdudtagelse og sæsonplanlægning → [`docs/PLANNING_CENTER_RULES.md`](docs/PLANNING_CENTER_RULES.md) · økonomi, værdi og løn → [`docs/ECONOMY_RULES.md`](docs/ECONOMY_RULES.md) · **sponsor, kontrakter og arketyper → [`docs/SPONSOR_RULES.md`](docs/SPONSOR_RULES.md)** · **bestyrelsen, mål og konsekvenser → [`docs/BOARD_RULES.md`](docs/BOARD_RULES.md)** · rytterudvikling, træning og rating → [`docs/PROGRESSION_RULES.md`](docs/PROGRESSION_RULES.md) · rytter-generering → [`docs/RIDER_GENERATION.md`](docs/RIDER_GENERATION.md) · forum → [`docs/FORUM_RULES.md`](docs/FORUM_RULES.md) · dashboard → [`docs/DASHBOARD_RULES.md`](docs/DASHBOARD_RULES.md) · spil-invarianter → [`docs/GAME_INVARIANTS.md`](docs/GAME_INVARIANTS.md) · delte kontrakter → [`docs/GUARDRAILS_CORE.md`](docs/GUARDRAILS_CORE.md) · **assistenten → [`docs/ASSISTANT_RULES.md`](docs/ASSISTANT_RULES.md)** · **træning → [`docs/TRAINING_RULES.md`](docs/TRAINING_RULES.md)** · **transfermarked og auktioner → [`docs/TRANSFER_MARKET_RULES.md`](docs/TRANSFER_MARKET_RULES.md)** · **sociale features → [`docs/SOCIAL_RULES.md`](docs/SOCIAL_RULES.md)**.
