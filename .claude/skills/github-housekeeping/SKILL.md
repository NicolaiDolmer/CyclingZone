...
|---|---|---|
| **STRONG** | Bruger-kommentar EFTER done-label med specifik prod-evidens: `verify-deploy.ps1 OK`, deploy-commit-hash, "verificeret på prod", ELLER PR-body `[x] Brugerverifikation` udfyldt | Foreslå **auto-close** hvis ≥24h |
...
- **B. Klar til lukning** — claude:done + STRONG + ≥24h
