...
-- Forummet udvides fra to til seks kategorier. Kilde: Discord
...
-- se opdateret §1-note i samme PR. Transfers tilføjet efter samme
-- ejer-beslutning, samme dag (4/9).
--
-- Nye kategorier: questions (Q&A), tactics (taktik/strategi), transfers,
-- off_topic. general + feedback_ideas er uændrede. "archive" er IKKE en
-- DB-værdi — det
...
--     WHERE category NOT IN ('general','feedback_ideas','questions','tactics','transfers','off_topic')
--     GROUP BY category;
